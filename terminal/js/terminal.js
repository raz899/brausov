...
hbd = function(name)
{
	switch (name){
		...
		case 'a':
			JTypeFill("hbd-info", `
				Всемиуважаемый Александр.
				<br /> 
				Поздравляю тебя с днем рождения,
				<br /> 
				желаю тебе успехов в жизни, счастья, здоровья.
				<br /> 
				Будь всегда таким же добрым и отзывчивым.
				<br /> 
				С Уважением, твой коллега.
				<br /> 
				<br /> 
				/// АНТОН
				<br />
		...
		case 'm':
			JTypeFill("hbd-info", `
				Санёк, с днём варенья!
				<br /> 
				Пусть у тебя все получается,
				<br /> 
				за что бы ты не брался!
				<br /> 
				Материальное пусть будет всегда в достатке,
				<br /> 
				а не материальное в избытке! 
				<br /> 
				<br /> 
				/// МАКСИМ
				<br />
		...
		case 'i':
			JTypeFill("hbd-info", `
				...
				<br /> 
				Побольше крышек в день зарплаты,
				<br /> 
				И не забывай одевать шапку,
				<br /> 
				Когда покидаешь убежище!
				<br /> 
				<br /> 
				/// ВАНЯ
				<br />
		...
		case 'p':
			JTypeFill("hbd-info", `
				...
				<br /> 
				<br /> 
				ТИП: Подарочный сертификат Sportmaster
				<br /> 
				НОМИНАЛ: 5000 руб.
				<br /> 
				НОМЕР КАРТЫ: 9300037136462019807
				<br /> 
				ПИН КОД ИЗ СМС: 27802
				<br /> 
				<br /> 
				ССЫЛКА НА PDF: <a target="_blank" href="https://disk.yandex.ru/d/G7OhyKWmmG7iVQ">Сертификат</a>
				<br /> 
				ССЫЛКА НА FAQ: <a target="_blank" href="https://www.sportmaster.ru/giftcard/faq/">FAQ</a>
				<br />
				<br />
				<d onclick="hbdReturn();">[Назад]</d>
				`, 15, "", "", "", true);
