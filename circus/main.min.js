...
(function() {
    ...
    b.Text.prototype.updateText = function() {
        ...
        for (this.canvas.height = h * c.length,
        ...
        f = 0; f < c.length; f++) {
            ...
            "right" === this.style.align ? i.x += e - d[f] : "center" === this.style.align && (i.x += (e - d[f]) / 2),
            this.style.stroke && this.style.strokeThickness && this.context.strokeText(c[f], i.x, i.y),
    ...
    b.TilingSprite.prototype._renderCanvas = function(a) {
        if (this.visible !== !1 && 0 !== this.alpha) {
            ...
            this.tilingTexture && (this.__tilePattern = c.createPattern(this.tilingTexture.baseTexture.source, "repeat"))),
            this.blendMode !== a.currentBlendMode && (a.currentBlendMode = this.blendMode,
            c.globalCompositeOperation = b.blendModesCanvas[a.currentBlendMode]),
            c.beginPath();
            ...
            c.fillRect(-e.x, -e.y, this.width / f.x, this.height / f.y),
            c.scale(1 / f.x, 1 / f.y),
            c.translate(-e.x, -e.y),
            c.closePath(),
            this._mask && a.maskManager.popMask(a.context)
    ...
    b.RenderTexture = function(a, c, d) {
        ...
        this.renderer.type === b.WEBGL_RENDERER) {
            ...
            this.textureBuffer = new b.FilterTexture(e,this.width,this.height),
            this.baseTexture._glTextures[e.id] = this.textureBuffer.texture,
    ...
    b.RenderTexture.prototype.resize = function(a, c) {
        ...
        this.renderer.type === b.WEBGL_RENDERER) {
            ...
            d.bindTexture(d.TEXTURE_2D, this.baseTexture._glTextures[d.id]),
...
function() {
    ...
    b.Circle.prototype = {
        ...
        distance: function(a, c) {
            ...
            c ? b.Math.distanceRound(this.x, this.y, a.x, a.y) : b.Math.distance(this.x, this.y, a.x, a.y)
        },
        clone: function(a) {
    ...
    b.Point.distance = function(a, c, d) {
        return "undefined" == typeof d && (d = !1),
        d ? b.Math.distanceRound(a.x, a.y, c.x, c.y) : b.Math.distance(a.x, a.y, c.x, c.y)
    }
    ,
    ...
    b.Line.intersectsPoints = function(a, c, d, e, f, g) {
        ...
        g.y = (i * l - h * m) / n,
        f) {
            if (Math.pow(g.x - c.x + (g.y - c.y), 2) > Math.pow(a.x - c.x + (a.y - c.y), 2))
                return null;
            if (Math.pow(g.x - a.x + (g.y - a.y), 2) > Math.pow(a.x - c.x + (a.y - c.y), 2))
                return null;
    ...
    b.StateManager.prototype = {
        ...
        preUpdate: function() {
            ...
            this._clearWorld && (this.game.tweens.removeAll(),
    ...
    b.PluginManager.prototype = {
        add: function(a) {
            var b = !1;
            return "function" == typeof a ? a = new a(this.game,this._parent) : (a.game = this.game,
            a.parent = this._parent),
            ...
            b = !0),
            b ? ((a.hasPreUpdate || a.hasUpdate || a.hasPostUpdate) && (a.active = !0),
    ...
    b.Stage.prototype.boot = function() {
        ...
        this.bounds = new b.Rectangle(this.offset.x,this.offset.y,this.game.width,this.game.height);
        var a = this;
    ...
    Object.defineProperty(b.Stage.prototype, "backgroundColor", {
        ...
        set: function(a) {
            ...
            this.game.transparent === !1 && ("string" == typeof a && (a = b.Color.hexToRGB(a)),
            this.setBackgroundColor(a))
        }
    }),
    ...
    b.Group.prototype.create = function(a, c, d, e, f) {
        ...
        return this.enableBody && this.game.physics.enable(g, this.physicsBodyType),
        g.exists = f,
        g.visible = f,
        g.alive = f,
        this.addChild(g),
        g.z = this.children.length,
    ...
    b.Group.prototype.next = function() {
        this.cursor && (this._cache[8] === this.children.length ? this._cache[8] = 0 : this._cache[8]++,
        this.cursor = this.children[this._cache[8]])
    }
    ,
    b.Group.prototype.previous = function() {
        this.cursor && (0 === this._cache[8] ? this._cache[8] = this.children.length - 1 : this._cache[8]--,
        this.cursor = this.children[this._cache[8]])
    }
    ,
    ...
    b.Group.prototype.replace = function(a, c) {
        ...
        -1 !== d && (void 0 !== c.parent && (c.events.onRemovedFromGroup.dispatch(c, this),
    ...
    b.Group.prototype.set = function(a, b, c, d, e, f) {
        ...
        "undefined" == typeof d && (d = !1),
        "undefined" == typeof e && (e = !1),
        (d === !1 || d && a.alive) && (e === !1 || e && a.visible) && this.setProperty(a, b, c, f)
    }
    ,
    b.Group.prototype.setAll = function(a, b, c, d, e) {
        ...
        for (var f = 0, g = this.children.length; g > f; f++)
            (!c || c && this.children[f].alive) && (!d || d && this.children[f].visible) && this.setProperty(this.children[f], a, b, e)
    }
    ,
    ...
    b.Group.prototype.remove = function(a) {
        return 0 !== this.children.length ? (a.events && a.events.onRemovedFromGroup.dispatch(a, this),
        this.removeChild(a),
        this.updateZ(),
    ...
    b.Group.prototype.removeBetween = function(a, b) {
        if (0 !== this.children.length) {
            if (a > b || 0 > a || b > this.children.length)
                return !1;
            for (var c = a; b > c; c++)
                this.children[c].events && this.children[c].events.onRemovedFromGroup.dispatch(this.children[c], this),
        ...
        if (null !== this.game) {
            ...
            a) {
                if (this.children.length > 0)
                    do
                        this.children[0].parent && this.children[0].destroy(a);
                    while (this.children.length > 0)
            } else
                this.removeAll();
    ...
    b.ScaleManager.prototype = {
        ...
        refresh: function() {
            if (this.game.device.iPad === !1 && this.game.device.webApp === !1 && this.game.device.desktop === !1 && (this.game.device.android && this.game.device.chrome === !1 ? window.scrollTo(0, 1) : window.scrollTo(0, 0)),
        ...
        setScreenSize: function(a) {
            ...
            this.incorrectOrientation === !0 ? this.setMaximum() : this.isFullScreen ? this.fullScreenScaleMode == b.ScaleManager.EXACT_FIT ? this.setExactFit() : this.fullScreenScaleMode == b.ScaleManager.SHOW_ALL && this.setShowAll() : this.scaleMode == b.ScaleManager.EXACT_FIT ? this.setExactFit() : this.scaleMode == b.ScaleManager.SHOW_ALL && this.setShowAll(),
            this.setSize(),
            clearInterval(this._check),
            this._check = null)
        },
        setSize: function() {
            this.incorrectOrientation === !1 && (this.maxWidth && this.width > this.maxWidth && (this.width = this.maxWidth),
            ...
            this.game.input.scale.setTo(this.game.width / this.width, this.game.height / this.height),
            this.pageAlignHorizontally && (this.width < window.innerWidth && this.incorrectOrientation === !1 ? (this.margin.x = Math.round((window.innerWidth - this.width) / 2),
            this.game.canvas.style.marginLeft = this.margin.x + "px") : (this.margin.x = 0,
            this.game.canvas.style.marginLeft = "0px")),
            this.pageAlignVertically && (this.height < window.innerHeight && this.incorrectOrientation === !1 ? (this.margin.y = Math.round((window.innerHeight - this.height) / 2),
    ...
    b.Game.prototype = {
        parseConfig: function(a) {
            ...
            a.seed && (this.rnd = new b.RandomDataGenerator(a.seed));
            var c = null;
            a.state && (c = a.state),
        ...
        boot: function() {
            ...
            this.plugins = new b.PluginManager(this,this),
        ...
        showDebugHeader: function() {
            ...
            this.device.chrome) {
                ...
                console.log("Phaser v" + a + " - Renderer: " + c + " - Audio: " + d + " - http://phaser.io")
        },
        ...
        update: function(a) {
            this.time.update(a),
            this._paused || this.pendingStep ? this.debug.preUpdate() : (this.stepping && (this.pendingStep = !0),
    ...
    b.Input = function(a) {
        ...
        this.onTap = null,
        this.onHold = null,
        this.interactiveItems = new b.LinkedList,
    ...
    b.Key.prototype = {
        ...
        justPressed: function(a) {
            return "undefined" == typeof a && (a = 2500),
    ...
    b.Keyboard.prototype = {
        ...
        update: function() {
            for (var a = this._keys.length; a--; )
                this._keys[a] && this._keys[a].update()
        },
        processKeyDown: function(a) {
            this.event = a,
        ...
        reset: function() {
            this.event = null;
            for (var a = this._keys.length; a--; )
                this._keys[a] && this._keys[a].reset()
        },
    ...
    b.Pointer.prototype = {
        ...
        move: function(a, c) {
            if (!this.game.input.pollLocked) {
                ...
                this.game.input.interactiveItems.total > 0) {
                    ...
                    do
                        (d.pixelPerfectClick || d.pixelPerfectOver || d.priorityID > this._highestInputPriorityID || d.priorityID === this._highestInputPriorityID && d.sprite._cache[3] < this._highestRenderOrderID) && (!c && d.checkPointerOver(this) || c && d.checkPointerDown(this)) && (this._highestRenderOrderID = d.sprite._cache[3],
                        this._highestInputPriorityID = d.priorityID,
                        this._highestRenderObject = d),
                        d = d.next;
                    while (null != d)
                }
        ...
        stop: function(a) {
            ...
            if (this.timeUp = this.game.time.now,
    ...
    b.InputHandler.prototype = {
        ...
        update: function(a) {
            return null !== this.sprite ? this.enabled && this.sprite.visible && this.sprite.parent.visible ? this.draggable && this._draggedPointerID == a.id ? this.updateDrag(a) : this._pointerData[a.id].isOver === !0 ? this.checkPointerOver(a) ? (this._pointerData[a.id].x = a.x - this.sprite.x,
        ...
        _releasedHandler: function(a) {
            ...
            this.checkPointerOver(a) ? this.sprite.events.onInputUp.dispatch(this.sprite, a, !0) : (this.sprite.events.onInputUp.dispatch(this.sprite, a, !1),
        ...
        startDrag: function(a) {
            ...
            this._dragPoint.setTo(this.sprite.cameraOffset.x - a.x, this.sprite.cameraOffset.y - a.y)) : this._dragPoint.setTo(this.sprite.cameraOffset.x - a.x, this.sprite.cameraOffset.y - a.y) : this.dragFromCenter ? (this.sprite.centerOn(a.x, a.y),
            this._dragPoint.setTo(this.sprite.x - a.x, this.sprite.y - a.y)) : this._dragPoint.setTo(this.sprite.x - a.x, this.sprite.y - a.y),
            this.updateDrag(a),
            this.bringToTop && this.sprite.bringToTop(),
    ...
    b.BitmapData.prototype = {
        ...
        resize: function(a, b) {
            ...
            this.imageData = this.context.getImageData(0, 0, a, b)),
            this._dirty = !0
        },
        ...
        setPixel32: function(a, b, c, d, e, f) {
            a >= 0 && a <= this.width && b >= 0 && b <= this.height && (this.pixels[b * this.width + a] = f << 24 | e << 16 | d << 8 | c,
        ...
        render: function() {
            this._dirty && (this.game.renderType === b.WEBGL && PIXI.updateWebGLTexture(this.baseTexture, this.game.renderer.gl),
            this._dirty = !1)
        }
    },
    ...
    b.Sprite.prototype.preUpdate = function() {
        if (1 === this._cache[4])
            ...
            this._cache[4] = 0,
            this.exists && this.body && this.body.preUpdate(),
            !1;
    ...
    b.Sprite.prototype.postUpdate = function() {
        this.key instanceof b.BitmapData && this.key._dirty && this.key.render(),
    ...
    b.Sprite.prototype.loadTexture = function(a, c) {
        ...
        void this.setTexture(a)) : a instanceof b.BitmapData ? (this.key = a.key,
    ...
    b.Button.prototype.onInputUpHandler = function(a, b, c) {
        ...
        this.freezeFrames || this.setState(this.forceOut ? 2 : this._onUpFrameName || this._onUpFrameID ? 4 : c ? 1 : 2)
    }
    ,
    ...
    b.RenderTexture = function(a, c, d, e) {
        ...
        PIXI.RenderTexture.call(this, c, d)
    }
    ,
    ...
    b.RetroFont.prototype.buildRetroFontText = function() {
        ...
        if (this.multiLine) {
            ...
            this.fixedWidth > 0 ? this.resize(this.fixedWidth, d.length * (this.characterHeight + this.customSpacingY) - this.customSpacingY) : this.resize(this.getLongestLine() * (this.characterWidth + this.customSpacingX), d.length * (this.characterHeight + this.customSpacingY) - this.customSpacingY),
            ...
            switch (this.fixedWidth > 0 ? this.resize(this.fixedWidth, this.characterHeight) : this.resize(this._text.length * (this.characterWidth + this.customSpacingX), this.characterHeight),
            this.textureBuffer.clear(),
            this.align) {
            case b.RetroFont.ALIGN_LEFT:
                a = 0;
    ...
    b.Math = {
        ...
        nearestAngleBetween: function(a, b, c) {
            "undefined" == typeof c && (c = !0);
            var d = c ? Math.PI : 180;
            return a = this.normalizeAngle(a, c),
        ...
        interpolateAngles: function(a, b, c, d, e) {
            ...
            "function" == typeof e ? e(c, a, b - a, 1) : this.interpolateFloat(a, b, c)
        },
    ...
    b.QuadTree.prototype = {
        ...
        retrieve: function(a) {
            ...
            return this.nodes[0] && (-1 !== c ? b = b.concat(this.nodes[c].retrieve(a)) : (b = b.concat(this.nodes[0].retrieve(a)),
        ...
        update: function(a) {
            ...
            1 == c) {
                if (this._repeat > 0) {
                    ...
                    return this._startTime = a + this._delayTime,
        ...
        update: function(a) {
            ...
            this._justResumed) {
                ...
                for (var b = 0; b < this._timers.length; b++)
                    this._timers[b]._resume()
            }
            if (this.timeToCall = this.game.math.max(0, 16 - (a - this.lastTime)),
        ...
        update: function(a) {
            ...
            this.running && this._now >= this.nextTick && this._len > 0) {
                for (this._i = 0; this._i < this._len && this.running && this._now >= this.events[this._i].tick; ) {
                    ...
                    0 > c && (c = this._now + this.events[this._i].delay),
                    this.events[this._i].loop === !0 ? (this.events[this._i].tick = c,
                ...
                this.events.length > 0 ? this.order() : (this.expired = !0,
                this.onComplete.dispatch(this))
            }
            return this.expired && this.autoDestroy ? !1 : !0
        },
        pause: function() {
            this.running && !this.expired && (this._pauseStarted = this.game.time.now,
            this.paused = !0,
            this._codePaused = !0)
        },
        _pause: function() {
    ...
    b.Cache.prototype = {
        ...
        getPhysicsData: function(a, b) {
            if ("undefined" == typeof b || null === b) {
                ...
                if (this._physics[a] && this._physics[a].data[b])
                    return this._physics[a].data[b];
    ...
    b.Loader.PHYSICS_LIME_CORONA = 3,
    b.Loader.prototype = {
        setPreloadSprite: function(a, c) {
            ...
            this.preloadSprite.crop = 0 === c ? new b.Rectangle(0,0,1,a.height) : new b.Rectangle(0,0,a.width,1),
        ...
        bitmapFont: function(a, b, c, d, e) {
            if (!b || /MSIE 9/i.test(navigator.userAgent))
                if ("function" == typeof window.DOMParser) {
                    ...
                    g.innerHTML = this.ajaxRequest.responseText,
                    b = g
                }
            var h = {}
              , i = b.getElementsByTagName("info")[0]
              , j = b.getElementsByTagName("common")[0];
            h.font = i.getAttribute("face"),
            h.size = parseInt(i.getAttribute("size"), 10),
            h.lineHeight = parseInt(j.getAttribute("lineHeight"), 10) + e,
            h.chars = {};
    ...
    b.Sound.prototype = {
        ...
        play: function(a, b, c, d, e) {
            ...
            this.isPlaying !== !0 || e !== !1 || this.override !== !1) {
                ...
                "" !== a) {
                    if (!this.markers[a])
                        return void console.warn("Phaser.Sound.play: audio marker " + a + " doesn't exist");
                    ...
                    this._tempVolume = c,
                    this._tempLoop = d;
                this.usingWebAudio ? this.game.cache.isSoundDecoded(this.key) ? (null == this._buffer && (this._buffer = this.game.cache.getSoundData(this.key)),
        ...
        stop: function() {
            this.isPlaying && this._sound && (this.usingWebAudio ? "undefined" == typeof this._sound.stop ? this._sound.noteOff(0) : this._sound.stop(0) : this.usingAudioTag && (this._sound.pause(),
            this._sound.currentTime = 0)),
            this.isPlaying = !1;
    ...
    b.SoundManager.prototype = {
        boot: function() {
            ...
            window.AudioContext ? this.context = new window.AudioContext : window.webkitAudioContext ? this.context = new window.webkitAudioContext : window.Audio ? (this.usingWebAudio = !1,
            this.usingAudioTag = !0) : (this.usingWebAudio = !1,
            this.noAudio = !0),
    ...
    b.Utils.Debug.prototype = {
        ...
        soundInfo: function(a, b, c, d) {
            ...
            "" !== a.currentMarker && (this.line("Marker: " + a.currentMarker + " Duration: " + a.duration),
    ...
    b.Physics.prototype = {
        ...
        startSystem: function(a) {
            a === b.Physics.ARCADE && null === this.arcade ? this.arcade = new b.Physics.Arcade(this.game) : a === b.Physics.P2JS && null === this.p2 && (this.p2 = new b.Physics.P2(this.game,this.config)),
            a === b.Physics.NINJA && null === this.ninja ? this.ninja = new b.Physics.Ninja(this.game) : a === b.Physics.BOX2D && null === this.box2d || a === b.Physics.CHIPMUNK && null === this.chipmunk
        },
    ...
    b.Physics.Arcade = function(a) {
        ...
        this._bounds1 = new b.Rectangle,
        this._bounds2 = new b.Rectangle,
        this._overlap = 0,
        this._maxOverlap = 0,
        this._velocity1 = 0,
        this._velocity2 = 0,
        ...
        this._dx = 0,
        this._dy = 0,
        this._intersection = new b.Rectangle
    }
    ,
    ...
    b.Physics.Arcade.prototype = {
        ...
        collideSpriteVsSprite: function(a, b, c, d, e, f) {
            this.separate(a.body, b.body, d, e, f) && (c && c.call(e, a, b),
            this._total++)
        },
        ...
        collideSpriteVsTilemapLayer: function(a, b, c, d, e) {
            if (this._mapData = b.getTiles(a.body.position.x - a.body.tilePadding.x, a.body.position.y - a.body.tilePadding.y, a.body.width + a.body.tilePadding.x, a.body.height + a.body.tilePadding.y, !0, !0),
        ...
        separate: function(a, c, d, e, f) {
            return b.Rectangle.intersects(a, c) ? d && d.call(e, a.sprite, c.sprite) === !1 ? !1 : this.separateX(a, c, f) || this.separateY(a, c, f) ? (this._result = !0,
            !0) : !1 : !1
        },
        separateX: function(a, c, d) {
            return a.immovable && c.immovable ? !1 : (this._overlap = 0,
            b.Rectangle.intersects(a, c) && (this._maxOverlap = a.deltaAbsX() + c.deltaAbsX() + this.OVERLAP_BIAS,
            0 === a.deltaX() && 0 === c.deltaX() ? (a.embedded = !0,
            c.embedded = !0) : a.deltaX() > c.deltaX() ? (this._overlap = a.x + a.width - c.x,
            this._overlap > this._maxOverlap || a.checkCollision.right === !1 || c.checkCollision.left === !1 ? this._overlap = 0 : (a.touching.none = !1,
            a.touching.right = !0,
            c.touching.none = !1,
            c.touching.left = !0)) : a.deltaX() < c.deltaX() && (this._overlap = a.x - c.width - c.x,
            -this._overlap > this._maxOverlap || a.checkCollision.left === !1 || c.checkCollision.right === !1 ? this._overlap = 0 : (a.touching.none = !1,
            a.touching.left = !0,
            c.touching.none = !1,
            c.touching.right = !0)),
            0 !== this._overlap) ? (a.overlapX = this._overlap,
            c.overlapX = this._overlap,
            d || a.customSeparateX || c.customSeparateX ? !0 : (this._velocity1 = a.velocity.x,
            this._velocity2 = c.velocity.x,
            a.immovable || c.immovable ? a.immovable ? c.immovable || (c.x += this._overlap,
            c.velocity.x = this._velocity1 - this._velocity2 * c.bounce.x) : (a.x = a.x - this._overlap,
            a.velocity.x = this._velocity2 - this._velocity1 * a.bounce.x) : (this._overlap *= .5,
            a.x = a.x - this._overlap,
            c.x += this._overlap,
            this._newVelocity1 = Math.sqrt(this._velocity2 * this._velocity2 * c.mass / a.mass) * (this._velocity2 > 0 ? 1 : -1),
            this._newVelocity2 = Math.sqrt(this._velocity1 * this._velocity1 * a.mass / c.mass) * (this._velocity1 > 0 ? 1 : -1),
            ...
            c.velocity.x = this._average + this._newVelocity2 * c.bounce.x),
            !0)) : !1)
        },
        separateY: function(a, c, d) {
            return a.immovable && c.immovable ? !1 : (this._overlap = 0,
            b.Rectangle.intersects(a, c) && (this._maxOverlap = a.deltaAbsY() + c.deltaAbsY() + this.OVERLAP_BIAS,
            0 === a.deltaY() && 0 === c.deltaY() ? (a.embedded = !0,
            c.embedded = !0) : a.deltaY() > c.deltaY() ? (this._overlap = a.y + a.height - c.y,
            this._overlap > this._maxOverlap || a.checkCollision.down === !1 || c.checkCollision.up === !1 ? this._overlap = 0 : (a.touching.none = !1,
            a.touching.down = !0,
            c.touching.none = !1,
            c.touching.up = !0)) : a.deltaY() < c.deltaY() && (this._overlap = a.y - c.height - c.y,
            -this._overlap > this._maxOverlap || a.checkCollision.up === !1 || c.checkCollision.down === !1 ? this._overlap = 0 : (a.touching.none = !1,
            a.touching.up = !0,
            c.touching.none = !1,
            c.touching.down = !0)),
            0 !== this._overlap) ? (a.overlapY = this._overlap,
            c.overlapY = this._overlap,
            d || a.customSeparateY || c.customSeparateY ? !0 : (this._velocity1 = a.velocity.y,
            this._velocity2 = c.velocity.y,
            a.immovable || c.immovable ? a.immovable ? c.immovable || (c.y += this._overlap,
            c.velocity.y = this._velocity1 - this._velocity2 * c.bounce.y,
            a.moves && (c.x += a.x - a.prev.x)) : (a.y = a.y - this._overlap,
            a.velocity.y = this._velocity2 - this._velocity1 * a.bounce.y,
            c.moves && (a.x += c.x - c.prev.x)) : (this._overlap *= .5,
            ...
            c.velocity.y = this._average + this._newVelocity2 * c.bounce.y),
            !0)) : !1)
        },
        separateTile: function(a, b, c) {
            if (!c.intersects(b.position.x, b.position.y, b.right, b.bottom))
                return !1;
            if (c.collisionCallback || c.layer.callbacks[c.index]) {
                if (c.collisionCallbackk && c.collisionCallback.call(c.collisionCallbackContext, b.sprite, c) === !1)
                    return !1;
                if (c.layer.callbacks[c.index] && c.layer.callbacks[c.index].callback.call(c.layer.callbacks[c.index].callbackContext, b.sprite, c) === !1)
                    return !1
            }
            var d = 0
              , e = 0
    ...
    b.Physics.Arcade.Body = function(a) {
        ...
        this.offset = new b.Point,
        0 !== a.anchor.x && (this.offset.x = a.anchor.x * a.width),
        0 !== a.anchor.y && (this.offset.y = a.anchor.y * a.height),
    ...
    b.Physics.Arcade.Body.prototype = {
        ...
        checkWorldBounds: function() {
            ...
            this.blocked.left = !0) : this.right > this.game.world.bounds.right && (this.x = this.game.world.bounds.right - this.width,
            this.velocity.x *= -this.bounce.x,
            this.blocked.right = !0),
            this.y < this.game.world.bounds.y ? (this.y = this.game.world.bounds.y,
            this.velocity.y *= -this.bounce.y,
            this.blocked.up = !0) : this.bottom > this.game.world.bounds.bottom && (this.y = this.game.world.bounds.bottom - this.height,
            this.velocity.y *= -this.bounce.y,
            this.blocked.down = !0)
        },
    ...
    b.Physics.Arcade.Body.renderBodyInfo = function(a, b) {
        ...
        a.line("velocity x: " + b.velocity.x.toFixed(2), "y: " + b.velocity.y.toFixed(2)),
    ...
    b.Particles.Arcade.Emitter.prototype.makeParticles = function(a, c, d, e, f) {
        ...
        "undefined" == typeof f && (f = !1);
        var g, h = 0, i = a, j = c;
        for (this._frames = c; d > h; )
            null === this.particleClass && ("object" == typeof a && (i = this.game.rnd.pick(a)),
            "object" == typeof c && (j = this.game.rnd.pick(c)),
            g = new b.Sprite(this.game,0,0,i,j),
            this.game.physics.arcade.enable(g, !1)),
            e ? (g.body.checkCollision.any = !0,
            g.body.checkCollision.none = !1) : g.body.checkCollision.none = !0,
    ...
    b.Particles.Arcade.Emitter.prototype.emitParticle = function() {
        ...
        if (null != a) {
            if (this.width > 1 || this.height > 1 ? a.reset(this.game.rnd.integerInRange(this.left, this.right), this.game.rnd.integerInRange(this.top, this.bottom)) : a.reset(this.emitX, this.emitY),
            ...
            a.body.angularVelocity = this.minRotation != this.maxRotation ? this.game.rnd.integerInRange(this.minRotation, this.maxRotation) : this.minRotation,
            ...
            a.frame = "object" == typeof this._frames ? this.game.rnd.pick(this._frames) : this._frames,
    ...
    b.Tilemap.prototype = {
        ...
        createFromObjects: function(a, c, d, e, f, g, h, i) {
            ...
            for (var j, k = 0, l = this.objects[a].length; l > k; k++)
                if (this.objects[a][k].gid === c) {
                    j = new i(this.game,this.objects[a][k].x,this.objects[a][k].y,d,e),
                    j.anchor.setTo(0, 1),
                    j.name = this.objects[a][k].name,
                    j.visible = this.objects[a][k].visible,
                    j.autoCull = g,
                    j.exists = f,
                    h.add(j);
                    for (var m in this.objects[a][k].properties)
                        h.set(j, m, this.objects[a][k].properties[m], !1, !1, 0)
                }
        },
        ...
        putTile: function(a, c, d, e) {
            ...
            c >= 0 && c < this.layers[e].width && d >= 0 && d < this.layers[e].height) {
                var f;
                a instanceof b.Tile ? (f = a.index,
                this.hasTile(c, d, e) ? this.layers[e].data[d][c].copy(a) : this.layers[e].data[d][c] = new b.Tile(e,f,c,d,a.width,a.height)) : (f = a,
                this.hasTile(c, d, e) ? this.layers[e].data[d][c].index = f : this.layers[e].data[d][c] = new b.Tile(e,f,c,d,this.tileWidth,this.tileHeight)),
        ...
        getTile: function(a, b, c) {
            ...
            a >= 0 && a < this.layers[c].width && b >= 0 && b < this.layers[c].height ? this.layers[c].data[b][a] : void 0
        },
    ...
    b.TilemapLayer = function(a, c, d, e, f) {
        ...
        this.dirty = !0,
        this.rayStepRate = 4,
        this._cw = c.tileWidth,
        this._ch = c.tileHeight,
        this._ga = 1,
        this._dx = 0,
        this._dy = 0,
        this._dw = 0,
    ...
    b.TilemapLayer.prototype._fixX = function(a) {
        return 0 > a && (a = 0),
        1 === this.scrollFactorX ? a : this._x + (a - this._x / this.scrollFactorX)
    }
    ,
    ...
    b.TilemapLayer.prototype._fixY = function(a) {
        return 0 > a && (a = 0),
        1 === this.scrollFactorY ? a : this._y + (a - this._y / this.scrollFactorY)
    }
    ,
    ...
    b.TilemapLayer.prototype.getTiles = function(a, b, c, d, e, f) {
        ...
        this._tw = (this.game.math.snapToCeil(c, this._cw) + this._cw) / this._cw,
        this._th = (this.game.math.snapToCeil(d, this._ch) + this._ch) / this._ch,
        this._results.length = 0;
        for (var g = this._ty; g < this._ty + this._th; g++)
            for (var h = this._tx; h < this._tx + this._tw; h++)
    ...
    b.TilemapLayer.prototype.updateMax = function() {
        ...
        this.layer && (this._maxX > this.layer.width && (this._maxX = this.layer.width),
    ...
    b.TilemapLayer.prototype.render = function() {
        ...
        this.dirty && this.visible) {
            ...
            for (var d = this._startY, e = this._startY + this._maxY; e > d; d++) {
                ...
                for (var f = this._startX, g = this._startX + this._maxX; g > f; f++)
                    ...
                    c.draw(this.context, Math.floor(this._tx), Math.floor(this._ty), a.index),
    ...
    b.TilemapLayer.prototype.renderDebug = function() {
        ...
        for (var a = this._startY, b = this._startY + this._maxY; b > a; a++) {
            ...
            for (var c = this._startX, d = this._startX + this._maxX; d > c; c++) {
                ...
                e && (e.faceTop || e.faceBottom || e.faceLeft || e.faceRight) && (this._tx = Math.floor(this._tx),
                this.debugFill && this.context.fillRect(this._tx, this._ty, this._cw, this._ch),
                this.context.beginPath(),
                e.faceTop && (this.context.moveTo(this._tx, this._ty),
                this.context.lineTo(this._tx + this._cw, this._ty)),
                e.faceBottom && (this.context.moveTo(this._tx, this._ty + this._ch),
                this.context.lineTo(this._tx + this._cw, this._ty + this._ch)),
                e.faceLeft && (this.context.moveTo(this._tx, this._ty),
                this.context.lineTo(this._tx, this._ty + this._ch)),
                e.faceRight && (this.context.moveTo(this._tx + this._cw, this._ty),
                this.context.lineTo(this._tx + this._cw, this._ty + this._ch)),
                this.context.stroke()),
                this._tx += this.map.tileWidth
            }
    ...
    Object.defineProperty(b.TilemapLayer.prototype, "scrollX", {
        ...
        set: function(a) {
            a !== this._x && a >= 0 && this.layer.widthInPixels > this.width && (this._x = a,
    ...
    Object.defineProperty(b.TilemapLayer.prototype, "scrollY", {
        ...
        set: function(a) {
            a !== this._y && a >= 0 && this.layer.heightInPixels > this.height && (this._y = a,
    ...
    b.TilemapParser = {
        ...
        parseCSV: function(a, c, d, e) {
            ...
            for (var g = [], h = c.split("\n"), i = h.length, j = 0, k = 0; k < h.length; k++) {
                ...
                for (var l = h[k].split(","), m = 0; m < l.length; m++)
                    g[k][m] = new b.Tile(0,parseInt(l[m], 10),m,k,d,e);
                0 === j && (j = l.length)
            }
            return f.name = a,
            f.width = j,
        ...
        parseTiledJSON: function(a) {
            ...
            c.width = a.width,
            c.height = a.height,
            c.tileWidth = a.tilewidth,
            c.tileHeight = a.tileheight,
            c.orientation = a.orientation,
            c.version = a.version,
            c.properties = a.properties,
            c.widthInPixels = c.width * c.tileWidth,
            c.heightInPixels = c.height * c.tileHeight;
            for (var d = [], e = 0; e < a.layers.length; e++)
                if ("tilelayer" === a.layers[e].type) {
                    ...
                    for (var g = 0, h = [], i = [], j = 0, k = a.layers[e].data.length; k > j; j++)
                        h.push(a.layers[e].data[j] > 0 ? new b.Tile(f,a.layers[e].data[j],g,i.length,a.tilewidth,a.tileheight) : null),
                        g++,
                        g === a.layers[e].width && (i.push(h),
                        g = 0,
                        h = []);
                    f.data = i,
                    d.push(f)
            ...
            for (var l = [], e = 0; e < a.layers.length; e++)
                if ("imagelayer" === a.layers[e].type) {
                    ...
                    a.layers[e].properties && (m.properties = a.layers[e].properties),
                    l.push(m)
                }
            c.images = l;
                ...
                if ("objectgroup" === a.layers[e].type) {
                    ...
                    for (var p = 0, k = a.layers[e].objects.length; k > p; p++)
                        if (a.layers[e].objects[p].gid) {
                            ...
                            q.polyline = [];
                            for (var r = 0; r < a.layers[e].objects[p].polyline.length; r++)
                                q.polyline.push([a.layers[e].objects[p].polyline[r].x, a.layers[e].objects[p].polyline[r].y]);
            ...
            for (var s = [], e = 0; e < a.tilesets.length; e++) {
                ...
                u.rows = Math.round((t.imageheight - t.margin) / (t.tileheight + t.spacing)),
                u.columns = Math.round((t.imagewidth - t.margin) / (t.tilewidth + t.spacing)),
                u.total = u.rows * u.columns,
                u.rows % 1 !== 0 || u.columns % 1 !== 0 ? console.warn("TileSet image dimensions do not match expected dimensions. Tileset width/height must be evenly divisible by Tilemap tile width/height.") : s.push(u)
            }
            c.tilesets = s,
            c.tiles = [];
            for (var e = 0; e < c.tilesets.length; e++)
                for (var t = c.tilesets[e], g = t.tileMargin, v = t.tileMargin, w = 0, x = 0, y = 0, j = t.firstgid; j < t.firstgid + t.total && (c.tiles[j] = [g, v, e],
                g += t.tileWidth + t.tileSpacing,
                w++,
                w !== t.total) && (x++,
                x !== t.columns || (g = t.tileMargin,
                v += t.tileHeight + t.tileSpacing,
                x = 0,
                y++,
                y !== t.rows)); j++)
                    ;
...
Phaser.Physics.Ninja = function(a) {
    ...
    this.gravity = .2,
    this.bounds = new Phaser.Rectangle(0,0,a.world.width,a.world.height),
    this.maxObjects = 10,
    this.maxLevels = 4,
...
Phaser.Physics.Ninja.prototype = {
    ...
    enable: function(a, b, c, d, e) {
        ...
        Array.isArray(a))
            for (i = a.length; i--; )
                a[i]instanceof Phaser.Group ? this.enable(a[i].children, b, c, d, e) : (this.enableBody(a[i], b, c, d),
                e && a[i].hasOwnProperty("children") && a[i].children.length > 0 && this.enable(a[i], b, c, d, !0));
        else
            a instanceof Phaser.Group ? this.enable(a.children, b, c, d, e) : (this.enableBody(a, b, c, d),
            e && a.hasOwnProperty("children") && a.children.length > 0 && this.enable(a.children, b, c, d, !0))
    },
    enableBody: function(a, b, c, d) {
        a.hasOwnProperty("body") && null === a.body && (a.body = new Phaser.Physics.Ninja.Body(this,a,b,c,d),
        a.anchor.set(.5))
    },
    ...
    convertTilemap: function(a, b, c) {
        ...
        "undefined" == typeof optimize && (optimize = !0),
    ...
    collideSpriteVsGroup: function(a, b, c, d, e, f) {
        if (0 !== b.length)
            for (var g = 0, h = b.children.length; h > g; g++)
                b.children[g].exists && b.children[g].body && this.separate(a.body, b.children[g].body, d, e, f) && (c && c.call(e, a, b.children[g]),
                this._total++)
    },
    collideGroupVsSelf: function(a, b, c, d, e) {
        if (0 !== a.length)
...
Phaser.Physics.Ninja.Body = function(a, b, c, d, e, f, g, h, i) {
    ...
    h = b.width,
    i = b.height,
    0 === b.anchor.x && (f += .5 * b.width),
    0 === b.anchor.y && (g += .5 * b.height)),
    1 === c ? (this.aabb = new Phaser.Physics.Ninja.AABB(this,f,g,h,i),
    this.shape = this.aabb) : 2 === c ? (this.circle = new Phaser.Physics.Ninja.Circle(this,f,g,e),
    this.shape = this.circle) : 3 === c && (this.tile = new Phaser.Physics.Ninja.Tile(this,f,g,h,i,d),
...
Phaser.Physics.Ninja.Body.prototype = {
    ...
    postUpdate: function() {
        this.sprite && (this.sprite.type === Phaser.TILESPRITE ? (this.sprite.x = this.shape.pos.x - this.shape.xw,
        this.sprite.y = this.shape.pos.y - this.shape.yw) : (this.sprite.x = this.shape.pos.x,
        this.sprite.y = this.shape.pos.y)),
        this.velocity.x < 0 ? this.facing = Phaser.LEFT : this.velocity.x > 0 && (this.facing = Phaser.RIGHT),
        this.velocity.y < 0 ? this.facing = Phaser.UP : this.velocity.y > 0 && (this.facing = Phaser.DOWN)
    },
    ...
    moveTo: function(a, b) {
        ...
        this.shape.pos.x = this.shape.oldpos.x + c * Math.cos(b),
        this.shape.pos.y = this.shape.oldpos.y + c * Math.sin(b)
    },
...
Phaser.Physics.Ninja.AABB = function(a, b, c, d, e) {
    ...
    this.pos = new Phaser.Point(b,c),
    this.oldpos = new Phaser.Point(b,c),
    this.xw = Math.abs(d / 2),
    this.yw = Math.abs(e / 2),
    this.width = d,
    this.height = e,
    this.oH = 0,
    this.oV = 0,
...
Phaser.Physics.Ninja.AABB.prototype = {
    integrate: function() {
        ...
        this.velocity.set(this.pos.x - a, this.pos.y - b),
        this.oldpos.set(a, b)
    },
    reportCollisionVsWorld: function(a, b, c, d) {
        ...
        0 > n ? (h = q * this.body.friction,
        i = r * this.body.friction,
        e = 1 + this.body.bounce,
        f = o * e,
        g = p * e,
        1 === c ? this.body.touching.left = !0 : -1 === c && (this.body.touching.right = !0),
        1 === d ? this.body.touching.up = !0 : -1 === d && (this.body.touching.down = !0)) : f = g = h = i = 0,
        j.x += a,
        j.y += b,
        k.x += a + f + h,
        k.y += b + g + i
    ...
    reverse: function() {
        ...
        this.oldpos.x < this.pos.x ? this.oldpos.x = this.pos.x + a : this.oldpos.x > this.pos.x && (this.oldpos.x = this.pos.x - a),
        this.oldpos.y < this.pos.y ? this.oldpos.y = this.pos.y + b : this.oldpos.y > this.pos.y && (this.oldpos.y = this.pos.y - b)
    },
    reportCollisionVsBody: function(a, b, c, d, e) {
        ...
        return this.body.immovable && e.body.immovable ? (a *= .5,
        b *= .5,
        this.pos.add(a, b),
        this.oldpos.set(this.pos.x, this.pos.y),
        e.pos.subtract(a, b),
        void e.oldpos.set(e.pos.x, e.pos.y)) : void (this.body.immovable || e.body.immovable ? this.body.immovable ? e.body.immovable || (e.pos.subtract(a, b),
        0 > h && e.reverse()) : (this.pos.subtract(a, b),
        0 > h && this.reverse()) : (a *= .5,
        b *= .5,
        this.pos.add(a, b),
        e.pos.subtract(a, b),
        0 > h && (this.reverse(),
    ...
    collideWorldBounds: function() {
        ...
        a > 0 ? this.reportCollisionVsWorld(a, 0, 1, 0, null) : (a = this.pos.x + this.xw - this.system.bounds.width,
        a > 0 && this.reportCollisionVsWorld(-a, 0, -1, 0, null));
        var b = this.system.bounds.y - (this.pos.y - this.yw);
        b > 0 ? this.reportCollisionVsWorld(0, b, 0, 1, null) : (b = this.pos.y + this.yw - this.system.bounds.height,
        b > 0 && this.reportCollisionVsWorld(0, -b, 0, -1, null))
    },
    collideAABBVsAABB: function(a) {
        ...
        if (i > 0) {
            ...
            if (k > 0) {
                ...
                return this.reportCollisionVsBody(i, k, i / l, k / l, c),
                Phaser.Physics.Ninja.AABB.COL_AXIS
            }
        }
        return !1
    },
    ...
    projAABB_Full: function(a, b, c, d) {
        ...
        return c.reportCollisionVsWorld(a, b, a / e, b / e, d),
        Phaser.Physics.Ninja.AABB.COL_AXIS
    },
    projAABB_Half: function(a, b, c, d) {
        ...
        if (0 > i) {
            ...
            var j = Math.sqrt(e * e + f * f)
              , k = Math.sqrt(a * a + b * b);
            return j > k ? (c.reportCollisionVsWorld(a, b, a / k, b / k, d),
            Phaser.Physics.Ninja.AABB.COL_AXIS) : (c.reportCollisionVsWorld(e, f, d.signx, d.signy, d),
            Phaser.Physics.Ninja.AABB.COL_OTHER)
        }
    ...
    projAABB_45Deg: function(a, b, c, d) {
        ...
        if (0 > k) {
            ...
            var l = Math.sqrt(i * i + j * j)
              , m = Math.sqrt(a * a + b * b);
            return l > m ? (c.reportCollisionVsWorld(a, b, a / m, b / m, d),
            Phaser.Physics.Ninja.AABB.COL_AXIS) : (c.reportCollisionVsWorld(i, j, d.sx, d.sy),
            Phaser.Physics.Ninja.AABB.COL_OTHER)
        }
        return Phaser.Physics.Ninja.AABB.COL_NONE
    },
        ...
        if (h * f > 0) {
            ...
            if (0 > m) {
                ...
                var n = Math.sqrt(k * k + l * l)
                  , o = Math.sqrt(a * a + b * b)
                  , p = Math.abs(h);
                return n > o ? o > p ? (c.reportCollisionVsWorld(0, h, 0, h / p, d),
                Phaser.Physics.Ninja.AABB.COL_OTHER) : (c.reportCollisionVsWorld(a, b, a / o, b / o, d),
                Phaser.Physics.Ninja.AABB.COL_AXIS) : n > p ? (c.reportCollisionVsWorld(0, h, 0, h / p, d),
                Phaser.Physics.Ninja.AABB.COL_OTHER) : (c.reportCollisionVsWorld(k, l, d.sx, d.sy, d),
                Phaser.Physics.Ninja.AABB.COL_OTHER)
            }
        }
        return Phaser.Physics.Ninja.AABB.COL_NONE
    ...
    projAABB_22DegB: function(a, b, c, d) {
        ...
        if (0 > k) {
            ...
            var l = Math.sqrt(i * i + j * j)
              , m = Math.sqrt(a * a + b * b);
            return l > m ? (c.reportCollisionVsWorld(a, b, a / m, b / m, d),
            Phaser.Physics.Ninja.AABB.COL_AXIS) : (c.reportCollisionVsWorld(i, j, d.sx, d.sy, d),
            Phaser.Physics.Ninja.AABB.COL_OTHER)
        }
        return Phaser.Physics.Ninja.AABB.COL_NONE
    },
        ...
        if (h * e > 0) {
            ...
            if (0 > m) {
                ...
                var n = Math.sqrt(k * k + l * l)
                  , o = Math.sqrt(a * a + b * b)
                  , p = Math.abs(h);
                return n > o ? o > p ? (c.reportCollisionVsWorld(h, 0, h / p, 0, d),
                Phaser.Physics.Ninja.AABB.COL_OTHER) : (c.reportCollisionVsWorld(a, b, a / o, b / o, d),
                Phaser.Physics.Ninja.AABB.COL_AXIS) : n > p ? (c.reportCollisionVsWorld(h, 0, h / p, 0, d),
                Phaser.Physics.Ninja.AABB.COL_OTHER) : (c.reportCollisionVsWorld(k, l, d.sx, d.sy, d),
                Phaser.Physics.Ninja.AABB.COL_OTHER)
            }
        }
    ...
    projAABB_Convex: function(a, b, c, d) {
        ...
        if (0 > e * g || 0 > f * h) {
            ...
            return c.reportCollisionVsWorld(a, b, a / m, b / m, d),
            Phaser.Physics.Ninja.AABB.COL_AXIS
        }
        return l > 0 ? (g /= i,
        h /= i,
        c.reportCollisionVsWorld(g * l, h * l, g, h, d),
        Phaser.Physics.Ninja.AABB.COL_OTHER) : Phaser.Physics.Ninja.AABB.COL_NONE
    },
    projAABB_Concave: function(a, b, c, d) {
        ...
        if (l > 0) {
            var m = Math.sqrt(a * a + b * b);
            return l > m ? (c.reportCollisionVsWorld(a, b, a / m, b / m, d),
            Phaser.Physics.Ninja.AABB.COL_AXIS) : (g /= k,
            h /= k,
            c.reportCollisionVsWorld(g * l, h * l, g, h, d),
            Phaser.Physics.Ninja.AABB.COL_OTHER)
        }
...
Phaser.Physics.Ninja.Tile = function(a, b, c, d, e, f) {
    "undefined" == typeof f && (f = Phaser.Physics.Ninja.Tile.EMPTY),
    this.body = a,
    this.system = a.system,
    this.id = f,
    ...
    this.id > 0 && this.setType(this.id)
}
,
...
Phaser.Physics.Ninja.Tile.prototype = {
    ...
    setType: function(a) {
        return a === Phaser.Physics.Ninja.Tile.EMPTY ? this.clear() : (this.id = a,
        this.updateType()),
        this
    },
    clear: function() {
    ...
    updateType: function() {
        if (0 === this.id)
            return this.type = Phaser.Physics.Ninja.Tile.TYPE_EMPTY,
            this.signx = 0,
            this.signy = 0,
            this.sx = 0,
            this.sy = 0,
        ...
        if (this.id < Phaser.Physics.Ninja.Tile.TYPE_45DEG)
            ...
            if (this.type = Phaser.Physics.Ninja.Tile.TYPE_45DEG,
            this.id == Phaser.Physics.Ninja.Tile.SLOPE_45DEGpn)
                this.signx = 1,
                this.signy = -1,
                ...
                if (this.id != Phaser.Physics.Ninja.Tile.SLOPE_45DEGpp)
                    return !1;
                this.signx = 1,
                this.signy = 1,
                this.sx = this.signx / Math.SQRT2,
            ...
            if (this.type = Phaser.Physics.Ninja.Tile.TYPE_CONCAVE,
            this.id == Phaser.Physics.Ninja.Tile.CONCAVEpn)
                this.signx = 1,
                this.signy = -1,
                this.sx = 0,
                this.sy = 0;
                ...
                if (this.id != Phaser.Physics.Ninja.Tile.CONCAVEpp)
                    return !1;
                this.signx = 1,
                this.signy = 1,
                this.sx = 0,
            ...
            if (this.type = Phaser.Physics.Ninja.Tile.TYPE_CONVEX,
            this.id == Phaser.Physics.Ninja.Tile.CONVEXpn)
                this.signx = 1,
                this.signy = -1,
                this.sx = 0,
                this.sy = 0;
                ...
                if (this.id != Phaser.Physics.Ninja.Tile.CONVEXpp)
                    return !1;
                this.signx = 1,
                this.signy = 1,
                this.sx = 0,
            ...
            if (this.type = Phaser.Physics.Ninja.Tile.TYPE_22DEGs,
            this.id == Phaser.Physics.Ninja.Tile.SLOPE_22DEGpnS) {
                this.signx = 1,
                this.signy = -1;
                var a = Math.sqrt(5);
                this.sx = 1 * this.signx / a,
                this.sy = 2 * this.signy / a
                ...
                if (this.id != Phaser.Physics.Ninja.Tile.SLOPE_22DEGppS)
                    return !1;
                this.signx = 1,
                this.signy = 1;
                var a = Math.sqrt(5);
            ...
            if (this.type = Phaser.Physics.Ninja.Tile.TYPE_22DEGb,
            this.id == Phaser.Physics.Ninja.Tile.SLOPE_22DEGpnB) {
                this.signx = 1,
                this.signy = -1;
                var a = Math.sqrt(5);
                this.sx = 1 * this.signx / a,
                ...
                if (this.id != Phaser.Physics.Ninja.Tile.SLOPE_22DEGppB)
                    return !1;
                this.signx = 1,
                this.signy = 1;
                var a = Math.sqrt(5);
            ...
            if (this.type = Phaser.Physics.Ninja.Tile.TYPE_67DEGs,
            this.id == Phaser.Physics.Ninja.Tile.SLOPE_67DEGpnS) {
                this.signx = 1,
                this.signy = -1;
                var a = Math.sqrt(5);
                this.sx = 2 * this.signx / a,
                this.sy = 1 * this.signy / a
                ...
                if (this.id != Phaser.Physics.Ninja.Tile.SLOPE_67DEGppS)
                    return !1;
                this.signx = 1,
                this.signy = 1;
                var a = Math.sqrt(5);
            ...
            if (this.type = Phaser.Physics.Ninja.Tile.TYPE_67DEGb,
            this.id == Phaser.Physics.Ninja.Tile.SLOPE_67DEGpnB) {
                this.signx = 1,
                this.signy = -1;
                var a = Math.sqrt(5);
                this.sx = 2 * this.signx / a,
                ...
                if (this.id != Phaser.Physics.Ninja.Tile.SLOPE_67DEGppB)
                    return !1;
                this.signx = 1,
                this.signy = 1;
                var a = Math.sqrt(5);
        ...
        else if (this.type = Phaser.Physics.Ninja.Tile.TYPE_HALF,
        this.id == Phaser.Physics.Ninja.Tile.HALFd)
            this.signx = 0,
            this.signy = -1,
            this.sx = this.signx,
            this.sy = this.signy;
            ...
            if (this.id != Phaser.Physics.Ninja.Tile.HALFr)
                return !1;
            this.signx = -1,
            this.signy = 0,
            this.sx = this.signx,
...
Phaser.Physics.Ninja.Circle.prototype = {
    ...
    collideWorldBounds: function() {
        ...
        a > 0 ? this.reportCollisionVsWorld(a, 0, 1, 0, null) : (a = this.pos.x + this.radius - this.system.bounds.width,
        a > 0 && this.reportCollisionVsWorld(-a, 0, -1, 0, null));
        var b = this.system.bounds.y - (this.pos.y - this.radius);
        b > 0 ? this.reportCollisionVsWorld(0, b, 0, 1, null) : (b = this.pos.y + this.radius - this.system.bounds.height,
        b > 0 && this.reportCollisionVsWorld(0, -b, 0, -1, null))
    },
    collideCircleVsTile: function(a) {
        ...
        if (j > 0) {
            ...
            if (l > 0)
                return this.oH = 0,
                this.oV = 0,
                -g > i ? this.oH = -1 : i > g && (this.oH = 1),
                -h > k ? this.oV = -1 : k > h && (this.oV = 1),
                this.resolveCircleTile(j, l, this.oH, this.oV, this, d)
        }
    },
    ...
    projCircle_Full: function(a, b, c, d, e, f) {
        if (0 == c) {
            if (0 == d) {
                if (b > a) {
                    ...
                    return 0 > g ? (e.reportCollisionVsWorld(-a, 0, -1, 0, f),
                    Phaser.Physics.Ninja.Circle.COL_AXIS) : (e.reportCollisionVsWorld(a, 0, 1, 0, f),
                    Phaser.Physics.Ninja.Circle.COL_AXIS)
                }
                var h = e.pos.y - f.pos.y;
                return 0 > h ? (e.reportCollisionVsWorld(0, -b, 0, -1, f),
                Phaser.Physics.Ninja.Circle.COL_AXIS) : (e.reportCollisionVsWorld(0, b, 0, 1, f),
                Phaser.Physics.Ninja.Circle.COL_AXIS)
            }
            return e.reportCollisionVsWorld(0, b * d, 0, d, f),
            Phaser.Physics.Ninja.Circle.COL_AXIS
        }
        if (0 == d)
            return e.reportCollisionVsWorld(a * c, 0, c, 0, f),
            Phaser.Physics.Ninja.Circle.COL_AXIS;
        var i = f.pos.x + c * f.xw
          ...
          , k = Math.sqrt(g * g + h * h)
          , l = e.radius - k;
        return l > 0 ? (0 == k ? (g = c / Math.SQRT2,
        h = d / Math.SQRT2) : (g /= k,
        h /= k),
        e.reportCollisionVsWorld(g * l, h * l, g, h, f),
        Phaser.Physics.Ninja.Circle.COL_OTHER) : Phaser.Physics.Ninja.Circle.COL_NONE
    },
        ...
        if (0 == c)
            if (0 == d) {
                ...
                if (0 > n) {
                    ...
                    b > a ? (g = a,
                    b = 0,
                    e.pos.x - f.pos.x < 0 && (a *= -1)) : (g = b,
                    a = 0,
                    e.pos.y - f.pos.y < 0 && (b *= -1));
                    var o = Math.sqrt(j * j + k * k);
                    return o > g ? (e.reportCollisionVsWorld(a, b, a / g, b / g, f),
                    Phaser.Physics.Ninja.Circle.COL_AXIS) : (e.reportCollisionVsWorld(j, k, f.sx, f.sy, f),
                ...
                if (p * h * i > 0) {
                    ...
                    if (r > 0)
                        return l /= q,
                        m /= q,
                        e.reportCollisionVsWorld(l * r, m * r, l, m, f),
                        Phaser.Physics.Ninja.Circle.COL_OTHER
                } else {
                    var n = l * j + m * k
                      , r = e.radius - Math.abs(n);
                    if (r > 0)
                        return e.reportCollisionVsWorld(j * r, k * r, j, k, f),
                        Phaser.Physics.Ninja.Circle.COL_OTHER
                }
            }
        else if (0 == d) {
            ...
            var s = f.pos.x + c * f.xw
              ...
              , r = e.radius - q;
            if (r > 0)
                return 0 == q ? (u = c / Math.SQRT2,
                v = d / Math.SQRT2) : (u /= q,
                v /= q),
                e.reportCollisionVsWorld(u * r, v * r, u, v, f),
                Phaser.Physics.Ninja.Circle.COL_OTHER
        }
        return Phaser.Physics.Ninja.Circle.COL_NONE
    },
    projCircle_Concave: function(a, b, c, d, e, f) {
        ...
        if (0 == c) {
            if (0 == d) {
                ...
                a = 0,
                e.pos.y - f.pos.y < 0 && (b *= -1)),
                o > g ? (e.reportCollisionVsWorld(a, b, a / g, b / g, f),
                Phaser.Physics.Ninja.Circle.COL_AXIS) : (j /= n,
                k /= n,
                e.reportCollisionVsWorld(j * o, k * o, j, k, f),
                Phaser.Physics.Ninja.Circle.COL_OTHER)) : Phaser.Physics.Ninja.Circle.COL_NONE
            }
            if (0 > i * d)
                return e.reportCollisionVsWorld(0, b * d, 0, d, f),
            ...
            if (o > 0)
                ...
                s = d) : (r /= n,
                s /= n),
                e.reportCollisionVsWorld(r * o, s * o, r, s, f),
                Phaser.Physics.Ninja.Circle.COL_OTHER
        } else if (0 == d) {
            if (0 > h * c)
                return e.reportCollisionVsWorld(a * c, 0, c, 0, f),
            ...
            if (0 == d) {
                ...
                if (0 > o) {
                    ...
                    var p = Math.sqrt(m * m + n * n)
                      , q = Math.sqrt(a * a + b * b);
                    return p > q ? (e.reportCollisionVsWorld(a, b, a / q, b / q, f),
                    Phaser.Physics.Ninja.Circle.COL_AXIS) : (e.reportCollisionVsWorld(m, n, f.signx, f.signy),
                    Phaser.Physics.Ninja.Circle.COL_OTHER)
                }
            } else {
                if (0 != i)
                ...
                var s = e.pos.y - (f.pos.y + d * f.yw)
                  ...
                  , u = e.radius - t;
                if (u > 0)
                    return 0 == t ? (r = g / Math.SQRT2,
                    s = d / Math.SQRT2) : (r /= t,
                    s /= t),
                    e.reportCollisionVsWorld(r * u, s * u, r, s, f),
                    Phaser.Physics.Ninja.Circle.COL_OTHER
            }
        else if (0 == d) {
            if (0 != i)
        ...
        if (0 == c) {
            ...
            if (n * g * h > 0) {
                ...
                if (p > 0)
                    return l /= o,
                    m /= o,
                    e.reportCollisionVsWorld(l * p, m * p, l, m, f),
                    Phaser.Physics.Ninja.Circle.COL_OTHER
            } else {
                l -= k * i,
                m -= k * j;
                ...
                if (0 > q) {
                    ...
                    return b > a ? (lenP = a,
                    b = 0,
                    e.pos.x - f.pos.x < 0 && (a *= -1)) : (lenP = b,
                    a = 0,
                    e.pos.y - f.pos.y < 0 && (b *= -1)),
                    r > lenP ? (e.reportCollisionVsWorld(a, b, a / lenP, b / lenP, f),
                    Phaser.Physics.Ninja.Circle.COL_AXIS) : (e.reportCollisionVsWorld(i, j, f.sx, f.sy, f),
                    Phaser.Physics.Ninja.Circle.COL_OTHER)
                }
            }
        } else if (0 == d)
            if (0 > g * c) {
                ...
                var o = Math.sqrt(u * u + v * v)
                  , p = e.radius - o;
                if (p > 0)
                    return 0 == o ? (u = c / Math.SQRT2,
                    v = d / Math.SQRT2) : (u /= o,
                    v /= o),
                    e.reportCollisionVsWorld(u * p, v * p, u, v, f),
                    Phaser.Physics.Ninja.Circle.COL_OTHER
            } else {
                var i = f.sx
                  , j = f.sy
                ...
                if (0 > n * g * h) {
                    ...
                    if (p > 0)
                        return e.reportCollisionVsWorld(i * p, j * p, i, j, f),
                        Phaser.Physics.Ninja.Circle.COL_OTHER
                }
            }
        else {
        ...
        if (0 == c)
            if (0 == d) {
                ...
                if (0 > n) {
                    ...
                    a = 0,
                    e.pos.y - f.pos.y < 0 && (b *= -1)),
                    o > lenP ? (e.reportCollisionVsWorld(a, b, a / lenP, b / lenP, f),
                    Phaser.Physics.Ninja.Circle.COL_AXIS) : (e.reportCollisionVsWorld(i, j, f.sx, f.sy, f),
                    Phaser.Physics.Ninja.Circle.COL_OTHER)
                }
            } else {
                ...
                if (p * g * h > 0) {
                    ...
                    var n = l * i + m * j
                      , r = e.radius - Math.abs(n);
                    if (r > 0)
                        return e.reportCollisionVsWorld(i * r, j * r, i, j, f),
                        Phaser.Physics.Ninja.Circle.COL_OTHER
                }
            }
        else if (0 == d) {
            ...
            if (0 > p * g * h) {
                ...
                var n = l * i + m * j
                  , r = e.radius - Math.abs(n);
                if (r > 0)
                    return e.reportCollisionVsWorld(i * r, j * r, f.sx, f.sy, f),
                    Phaser.Physics.Ninja.Circle.COL_OTHER
            }
        } else {
            if (g * c + h * d > 0) {
                var s = Math.sqrt(5)
                  ...
                  , m = e.pos.y - j * k - (f.pos.y + h * f.yw)
                  , n = l * i + m * j;
                return 0 > n ? (e.reportCollisionVsWorld(-i * n, -j * n, f.sx, f.sy, f),
                Phaser.Physics.Ninja.Circle.COL_OTHER) : Phaser.Physics.Ninja.Circle.COL_NONE
            }
            var t = f.pos.x + c * f.xw
              ...
              , r = e.radius - q;
            if (r > 0)
                return 0 == q ? (v = c / Math.SQRT2,
                w = d / Math.SQRT2) : (v /= q,
                w /= q),
                e.reportCollisionVsWorld(v * r, w * r, v, w, f),
                Phaser.Physics.Ninja.Circle.COL_OTHER
        }
        return Phaser.Physics.Ninja.Circle.COL_NONE
    },
            ...
            if (0 == d) {
                ...
                if (n * g * h > 0) {
                    ...
                    var q = l * i + m * j
                      , p = e.radius - Math.abs(q);
                    if (p > 0)
                        return e.reportCollisionVsWorld(i * p, j * p, f.sx, f.sy, f),
                        Phaser.Physics.Ninja.Circle.COL_OTHER
                }
            }
        else {
    ...
    return function a(b, c, d) {
        ...
        5: [function(a, b) {
            ...
            c.prototype.canSee = function(a, b) {
                var c, d, g = h, j = i;
                if (f.leftOn(this.at(a + 1), this.at(a), this.at(b)) && f.rightOn(this.at(a - 1), this.at(a), this.at(b)))
                    return !1;
                d = f.sqdist(this.at(a), this.at(b));
                for (var k = 0; k !== this.vertices.length; ++k)
                    if ((k + 1) % this.vertices.length !== a && k !== a && f.leftOn(this.at(a), this.at(b), this.at(k + 1)) && f.rightOn(this.at(a), this.at(b), this.at(k)) && (g[0] = this.at(a),
                    g[1] = this.at(b),
                    j[0] = this.at(k),
                    j[1] = this.at(k + 1),
                    c = e.lineInt(g, j),
                    f.sqdist(this.at(a), c) < d))
                        return !1;
                return !0
            }
            ,
            ...
            c.prototype.isSimple = function() {
                for (var a = this.vertices, b = 0; b < a.length - 1; b++)
                    for (var c = 0; b - 1 > c; c++)
                        if (e.segmentsIntersect(a[b], a[b + 1], a[c], a[c + 1]))
                            return !1;
                for (var b = 1; b < a.length - 2; b++)
                    if (e.segmentsIntersect(a[0], a[a.length - 1], a[b], a[b + 1]))
                        return !1;
                return !0
            }
            ,
                ...
                for (var x = 0; x < this.vertices.length; ++x)
                    if (v.isReflex(x)) {
                        ...
                        for (var y = 0; y < this.vertices.length; ++y)
                            f.left(v.at(x - 1), v.at(x), v.at(y)) && f.rightOn(v.at(x - 1), v.at(x), v.at(y - 1)) && (l = d(v.at(x - 1), v.at(x), v.at(y), v.at(y - 1)),
                            f.right(v.at(x + 1), v.at(x), l) && (o = f.sqdist(v.vertices[x], l),
                            n > o && (n = o,
                            k = l,
                            r = y))),
                            f.left(v.at(x + 1), v.at(x), v.at(y + 1)) && f.rightOn(v.at(x + 1), v.at(x), v.at(y)) && (l = d(v.at(x + 1), v.at(x), v.at(y), v.at(y + 1)),
                            f.left(v.at(x - 1), v.at(x), l) && (o = f.sqdist(v.vertices[x], l),
                            m > o && (m = o,
                            j = l,
                            q = y)));
                        if (r == (q + 1) % this.vertices.length)
                            ...
                            r > q)
                                return a;
                            for (var y = r; q >= y; ++y)
                                f.leftOn(v.at(x - 1), v.at(x), v.at(y)) && f.rightOn(v.at(x + 1), v.at(x), v.at(y)) && (o = f.sqdist(v.at(x), v.at(y)),
                                p > o && (p = o,
                        ...
                        u.quickDecomp(a, b, e, g, h, i)) : (u.quickDecomp(a, b, e, g, h, i),
                        t.quickDecomp(a, b, e, g, h, i)),
                        a
                    }
                return a.push(this),
                a
            ...
            c.prototype.removeCollinearPoints = function(a) {
                for (var b = 0, c = this.vertices.length - 1; this.vertices.length > 3 && c >= 0; --c)
                    f.collinear(this.at(c - 1), this.at(c), this.at(c + 1), a) && (this.vertices.splice(c % this.vertices.length, 1),
                    c--,
                    b++);
                return b
            }
        ...
        9: [function(a, b) {
            ...
            c.prototype.setFromPoints = function(a, b, c) {
                var f = this.lowerBound
                  , g = this.upperBound;
                d.set(f, Number.MAX_VALUE, Number.MAX_VALUE),
                d.set(g, -Number.MAX_VALUE, -Number.MAX_VALUE);
                for (var h = 0; h < a.length; h++) {
                    var i = a[h];
                    "number" == typeof c && (d.rotate(e, i, c),
                    i = e);
                    for (var j = 0; 2 > j; j++)
                        i[j] > g[j] && (g[j] = i[j]),
                        i[j] < f[j] && (f[j] = i[j])
            ...
            c.prototype.extend = function(a) {
                for (var b = 0; 2 > b; b++)
                    a.lowerBound[b] < this.lowerBound[b] && (this.lowerBound[b] = a.lowerBound[b]),
                    a.upperBound[b] > this.upperBound[b] && (this.upperBound[b] = a.upperBound[b])
            }
            ,
        ...
        10: [function(a, b) {
            ...
            c.aabbCheck = function(a, b) {
                return a.aabbNeedsUpdate && a.updateAABB(),
        ...
        11: [function(a, b) {
            ...
            b.exports = d,
            d.prototype = new h,
            d.prototype.getBinIndex = function(a, b) {
                var c = this.nx
                  , d = this.ny
                  , e = this.xmin
                  , f = this.ymin
            ...
            d.prototype.getCollisionPairs = function(a) {
                for (var b = [], d = a.bodies, i = i = d.length, j = this.binsizeX, k = this.binsizeY, l = [], m = nx * ny, n = 0; m > n; n++)
                    l.push([]);
        ...
        12: [function(a, b) {
            ...
            c.prototype.getCollisionPairs = function(a) {
                ...
                for (h.length = 0,
                b = 0,
                Ncolliding = g.length; b !== Ncolliding; b++)
                    for (e = g[b],
                    c = 0; b > c; c++)
                        f = g[c],
                        d.canCollide(e, f) && i(e, f) && h.push(e, f);
                return h
            }
        }
        , {
        ...
        13: [function(a, b) {
            ...
            function d(a) {
                for (var b = 0, c = a.keys.length; c > b; b++)
                    delete a[a.keys[b]];
                a.keys.length = 0
            }
            function e(a, b) {
            ...
            c.prototype.reset = function() {
                ...
                for (var a = 0; a !== this.contactEquations.length; a++) {
                    ...
                    var g = c + " " + e;
                    this.collidingBodiesLastStep[g] || (this.collidingBodiesLastStep[g] = !0,
                    this.collidingBodiesLastStep.keys.push(g))
                }
            ...
            c.prototype.createContactEquation = function(a, b, c, d) {
                ...
                e.enabled = !0,
                a.allowSleep && a.motionState == p.DYNAMIC && b.motionState != p.STATIC && b.sleepState !== p.SLEEPY && a.wakeUp(),
                b.allowSleep && b.motionState == p.DYNAMIC && a.motionState != p.STATIC && a.sleepState !== p.SLEEPY && b.wakeUp(),
                e
            }
            ,
            c.prototype.createFrictionEquation = function(a, b, c, d) {
                ...
                e.enabled = !0,
                e.frictionStiffness = this.frictionStiffness,
                e.frictionRelaxation = this.frictionRelaxation,
                e
            }
            ,
            c.prototype.createFrictionFromContact = function(a) {
                var b = this.createFrictionEquation(a.bi, a.bj, a.shapeA, a.shapeB);
                return g.copy(b.ri, a.ri),
                g.copy(b.rj, a.rj),
                g.rotate(b.t, a.ni, -Math.PI / 2),
                b.contactEquation = a,
                b
            }
            ,
            ...
            c.prototype[o.CAPSULE | o.CAPSULE] = c.prototype.capsuleCapsule = function(a, b, c, d, f, h, i, j, k) {
                for (var l = N, m = O, n = 0, o = 0; 2 > o; o++) {
                    g.set(l, (0 == o ? -1 : 1) * b.length / 2, 0),
                    g.rotate(l, l, d),
                    g.add(l, l, c);
                    for (var p = 0; 2 > p; p++) {
                        g.set(m, (0 == p ? -1 : 1) * h.length / 2, 0),
                        g.rotate(m, m, j),
                        g.add(m, m, i);
            ...
            c.prototype[o.PLANE | o.LINE] = c.prototype.planeLine = function(a, b, c, d, e, f, k, l, m) {
                ...
                for (var H = 0; H < G.length; H++) {
                    ...
                    if (0 > J) {
                        ...
                        numContacts++,
                        g.copy(L.ni, E),
                        g.normalize(L.ni, L.ni),
                        g.scale(D, E, J),
                        h(L.ri, I, D),
                        h(L.ri, L.ri, a.position),
                        h(L.rj, I, k),
                        i(L.rj, L.rj, k),
                        h(L.rj, L.rj, e.position),
            ...
            c.prototype[o.CIRCLE | o.LINE] = c.prototype.circleLine = function(a, b, c, d, e, f, k, l, m, n, o) {
                var p = f
                  ...
                  , Y = F
                  , Z = K;
                g.set(S, -p.length / 2, 0),
                g.set(T, p.length / 2, 0),
                g.rotate(U, S, q),
                g.rotate(V, T, q),
                i(U, U, G),
                i(V, V, G),
                ...
                Math.abs($) < o + n) {
                    ...
                    if (_ > ab && bb > _) {
                        ...
                        return g.scale(cb.ni, L, -1),
                        g.normalize(cb.ni, cb.ni),
                        g.scale(cb.ri, cb.ni, o),
                        i(cb.ri, cb.ri, H),
                        h(cb.ri, cb.ri, I.position),
                        h(cb.rj, N, G),
                        i(cb.rj, cb.rj, G),
                        h(cb.rj, cb.rj, r.position),
                        this.contactEquations.push(cb),
                        this.enableFriction && this.frictionEquations.push(this.createFrictionFromContact(cb)),
                        1
                    }
                }
                Z[0] = S,
                ...
                for (var db = 0; db < Z.length; db++) {
                    var eb = Z[db];
                    if (h(W, eb, H),
                    g.squaredLength(W) < (o + n) * (o + n)) {
                        if (m)
                            return !0;
                        var cb = this.createContactEquation(I, r, b, f);
                        return g.copy(cb.ni, W),
                        g.normalize(cb.ni, cb.ni),
                        g.scale(cb.ri, cb.ni, o),
                        i(cb.ri, cb.ri, H),
                        h(cb.ri, cb.ri, I.position),
            ...
            c.prototype[o.CIRCLE | o.CONVEX] = c.prototype[o.CIRCLE | o.RECTANGLE] = c.prototype.circleConvex = function(a, b, c, d, e, j, k, l, m, n) {
                ...
                for (var T = 0; T !== verts.length + 1; T++) {
                    ...
                    h(I, D, A),
                    g.normalize(J, I),
                    g.rotate(K, J, -Math.PI / 2),
                    g.scale(O, K, -z.radius),
                    i(O, O, x),
                    f(O, o, r, p)) {
                        g.sub(P, A, O);
                ...
                if (R) {
                    ...
                    return g.sub(X.ni, Q, x),
                    g.normalize(X.ni, X.ni),
                    g.scale(X.ri, X.ni, n),
                    i(X.ri, X.ri, x),
                    h(X.ri, X.ri, y.position),
                    h(X.rj, N, r),
                    i(X.rj, X.rj, r),
                    h(X.rj, X.rj, q.position),
                ...
                if (n > 0)
                    for (var T = 0; T < verts.length; T++) {
                        ...
                        i(M, M, r),
                        h(L, M, x),
                        g.squaredLength(L) < n * n) {
                            if (m)
                                return !0;
                            var X = this.createContactEquation(y, q, b, j);
                            return g.copy(X.ni, L),
                            g.normalize(X.ni, X.ni),
                            g.scale(X.ri, X.ni, n),
                            i(X.ri, X.ri, x),
                            h(X.ri, X.ri, y.position),
            ...
            c.prototype[o.PARTICLE | o.CONVEX] = c.prototype[o.PARTICLE | o.RECTANGLE] = c.prototype.particleConvex = function(a, b, c, d, e, k, l, m, n) {
                ...
                if (R) {
                    ...
                    return g.scale(X.ni, P, -1),
                    g.normalize(X.ni, X.ni),
                    g.set(X.ri, 0, 0),
                    i(X.ri, X.ri, z),
                    h(X.ri, X.ri, A.position),
                    h(X.rj, N, r),
                    i(X.rj, X.rj, r),
                    h(X.rj, X.rj, q.position),
                    this.contactEquations.push(X),
            ...
            c.prototype[o.CIRCLE] = c.prototype.circleCircle = function(a, b, c, d, e, f, j, k, l, m, n) {
                ...
                g.scale(x.rj, x.ni, -n),
                i(x.ri, x.ri, q),
                h(x.ri, x.ri, o.position),
                i(x.rj, x.rj, u),
                h(x.rj, x.rj, r.position),
                this.contactEquations.push(x),
                this.enableFriction && this.frictionEquations.push(this.createFrictionFromContact(x)),
                1
            }
            ...
            c.prototype.convexPlane = function(a, b, c, d, e, f, g, h, i) {
                return console.warn("Narrowphase.prototype.convexPlane is deprecated. Use planeConvex instead!"),
                this.planeConvex(e, f, g, h, a, b, c, d, i)
            }
            ,
            ...
            c.prototype[o.CIRCLE | o.PARTICLE] = c.prototype.circleParticle = function(a, b, c, d, e, f, j, k, l) {
                var m = a
                  ...
                  , r = s;
                if (h(r, q, o),
                g.squaredLength(r) > n.radius * n.radius)
                    return 0;
                if (l)
                    return !0;
                var t = this.createContactEquation(m, p, b, f);
                return g.copy(t.ni, r),
                g.normalize(t.ni, t.ni),
                g.scale(t.ri, t.ni, n.radius),
                i(t.ri, t.ri, o),
                h(t.ri, t.ri, m.position),
                h(t.rj, q, p.position),
            ...
            c.prototype.capsulePlane = function(a, b, c, d, e, f, g, h, i) {
                return console.warn("Narrowphase.prototype.capsulePlane() is deprecated. Use .planeCapsule() instead!"),
                this.planeCapsule(e, f, g, h, a, b, c, d, i)
            }
            ,
            c.prototype[o.CIRCLE | o.PLANE] = c.prototype.circlePlane = function(a, b, c, d, e, f, k, l, m) {
                ...
                g.scale(B.rj, B.ni, -o.radius),
                i(B.rj, B.rj, p),
                h(B.rj, B.rj, n.position),
                g.scale(z, B.ni, A),
                h(B.ri, x, z),
                i(B.ri, B.ri, v),
                h(B.ri, B.ri, q.position),
                this.contactEquations.push(B),
                this.enableFriction && this.frictionEquations.push(this.createFrictionFromContact(B)),
                1
            }
            ,
            c.convexPrecision = 1e-10,
            c.prototype[o.CONVEX] = c.prototype[o.CONVEX | o.RECTANGLE] = c.prototype[o.RECTANGLE] = c.prototype.convexConvex = function(a, b, d, e, f, k, l, m, n, o) {
                var p = s
                  , q = t
                  , r = u
                  , x = v
                ...
                for (var J = 0; 2 > J; J++) {
                    ...
                    for (var V = L; L + 2 > V; V++) {
                        ...
                        if (3 == X) {
                            ...
                            i(x, x, O),
                            h(B, x, r),
                            g.rotate(ab.ni, B, -Math.PI / 2),
                            g.normalize(ab.ni, ab.ni),
                            h(D, q, r);
                            var _ = j(ab.ni, D);
                            g.scale(C, ab.ni, _),
                            h(ab.ri, q, O),
                            h(ab.ri, ab.ri, C),
                            i(ab.ri, ab.ri, O),
                            h(ab.ri, ab.ri, S.position),
                            h(ab.rj, q, P),
                            i(ab.rj, ab.rj, P),
                            h(ab.rj, ab.rj, T.position),
                            this.contactEquations.push(ab),
                            this.enableFriction && this.frictionEquations.push(this.createFrictionFromContact(ab))
                        }
                    }
                }
                return F
            ...
            c.findSeparatingAxis = function(a, b, d, e, f, i, j) {
                for (var k = null, l = !1, m = !1, n = Y, o = Z, p = $, q = _, r = ab, s = bb, t = 0; 2 !== t; t++) {
                    ...
                    for (var w = 0; w !== u.vertices.length; w++) {
                        g.rotate(o, u.vertices[w], v),
                        g.rotate(p, u.vertices[(w + 1) % u.vertices.length], v),
                        h(n, p, o),
                        g.rotate(q, n, -Math.PI / 2),
                        g.normalize(q, q),
                        c.projectConvexOntoAxis(a, b, d, q, r),
                        c.projectConvexOntoAxis(e, f, i, q, s);
                        var x = r
                          , y = s
                          , z = !1;
                        r[0] > s[0] && (y = r,
            ...
            c.prototype[o.CIRCLE | o.HEIGHTFIELD] = c.prototype.circleHeightfield = function(a, b, c, d, e, f, j, k, l, m) {
                ...
                for (var B = !1, C = !1, A = w; x > A; A++) {
                    ...
                    g.sub(p, q, u);
                    var D = g.dot(p, t);
                    if (q[0] >= u[0] && q[0] < v[0] && 0 >= D && (C === !1 || Math.abs(D) < C) && (g.scale(p, t, -D),
                    g.add(r, q, p),
                    g.copy(s, t),
                    B = !0,
                    C = Math.abs(D),
                ...
                if (B) {
                    ...
                    return g.copy(E.ni, s),
                    g.scale(E.rj, E.ni, -m),
                    i(E.rj, E.rj, c),
                    h(E.rj, E.rj, a.position),
                    g.copy(E.ri, r),
                    g.sub(E.ri, E.ri, e.position),
                ...
                if (m > 0)
                    for (var A = w; x >= A; A++)
                        ...
                        g.add(u, u, j),
                        g.sub(p, c, u),
                        g.squaredLength(p) < m * m) {
                            if (l)
                                return !0;
                            var E = this.createContactEquation(e, a, f, b);
                            return g.copy(E.ni, p),
                            g.normalize(E.ni, E.ni),
                            g.scale(E.rj, E.ni, -m),
                            i(E.rj, E.rj, c),
                            h(E.rj, E.rj, a.position),
                            h(E.ri, u, j),
                            i(E.ri, E.ri, j),
                            h(E.ri, E.ri, e.position),
                            this.contactEquations.push(E),
                            this.enableFriction && this.frictionEquations.push(this.createFrictionFromContact(E)),
                            1
                        }
        ...
        14: [function(a, b) {
            function c(a, b, c, f) {
                var g;
                g = b ? new d(a,0,c,f) : new e(a,0,c,f),
                this.root = g
            }
            function d(a, b, c, d) {
                this.bounds = a,
            ...
            ,
            d.prototype.classConstructor = d,
            d.prototype.children = null,
            d.prototype.depth = 0,
            d.prototype.maxChildren = 4,
            d.prototype.maxDepth = 4,
            d.TOP_LEFT = 0,
            d.TOP_RIGHT = 1,
            d.BOTTOM_LEFT = 2,
            d.BOTTOM_RIGHT = 3,
            ...
            d.prototype.findIndex = function(a) {
                ...
                var g = d.TOP_LEFT;
                return c ? e || (g = d.BOTTOM_LEFT) : g = e ? d.TOP_RIGHT : d.BOTTOM_RIGHT,
                g
            }
            ,
            d.prototype.subdivide = function() {
                ...
                this.nodes[d.TOP_RIGHT] = new this.classConstructor({
                    x: g,
                    y: c,
                    width: e,
                    height: f
                },a),
                this.nodes[d.BOTTOM_LEFT] = new this.classConstructor({
                    x: b,
                    y: h,
                    width: e,
                    height: f
                },a),
                this.nodes[d.BOTTOM_RIGHT] = new this.classConstructor({
                    x: g,
                    y: h,
                    width: e,
                    height: f
            ...
            d.prototype.clear = function() {
                this.children.length = 0;
                for (var a = this.nodes.length, b = 0; a > b; b++)
                    this.nodes[b].clear();
                this.nodes.length = 0
            }
            ,
            e.prototype = new d,
            e.prototype.classConstructor = e,
            e.prototype.stuckChildren = null,
            e.prototype.out = [],
            ...
            e.prototype.retrieve = function(a) {
                ...
                return b.push.apply(b, this.stuckChildren),
                b.push.apply(b, this.children),
                b
            }
            ,
        ...
        15: [function(a, b) {
            ...
            c.prototype.setWorld = function(a) {
                ...
                d.appendArray(this.axisListX, a.bodies),
                d.appendArray(this.axisListY, a.bodies),
            ...
            c.sortAxisListX = function(a) {
                for (var b = 1, c = a.length; c > b; b++) {
                    for (var d = a[b], e = b - 1; e >= 0 && !(a[e].aabb.lowerBound[0] <= d.aabb.lowerBound[0]); e--)
                        a[e + 1] = a[e];
                    a[e + 1] = d
                }
                return a
            ...
            c.sortAxisListY = function(a) {
                for (var b = 1, c = a.length; c > b; b++) {
                    for (var d = a[b], e = b - 1; e >= 0 && !(a[e].aabb.lowerBound[1] <= d.aabb.lowerBound[1]); e--)
                        a[e + 1] = a[e];
                    a[e + 1] = d
                }
                return a
        ...
        17: [function(a, b) {
            function c(a, b, c, g) {
                ...
                h.computeGq = function() {
                    return f.sub(i, b.position, a.position),
                    f.length(i) - c
                }
                ,
                this.setMaxForce(g)
        ...
        18: [function(a, b) {
            function c(a, b, c) {
                ...
                this.angle = "number" == typeof c.angle ? c.angle : 0,
        ...
        19: [function(a, b) {
            function c(a, b, c) {
                ...
                j.computeGq = function() {
                    return e.rotate(m, h, a.angle),
                    e.sub(n, b.position, a.position),
                    e.sub(n, n, m),
                    n[0]
                }
                ,
                ...
                l.computeGq = function() {
                    return e.rotate(o, h, b.angle - i),
                    e.scale(o, o, -1),
                    e.sub(n, a.position, b.position),
                    e.add(n, n, o),
        ...
        20: [function(a, b) {
            ...
            c.prototype.update = function() {
                ...
                if (this.upperLimitEnabled && s > c)
                    g.scale(e.ni, i, -1),
                    g.sub(e.ri, j, h.position),
                    g.sub(e.rj, k, o.position),
                    g.scale(n, i, c),
                    g.add(e.ri, e.ri, n),
                ...
                if (this.lowerLimitEnabled && d > s)
                    g.scale(f.ni, i, 1),
                    g.sub(f.ri, j, h.position),
                    g.sub(f.rj, k, o.position),
                    g.scale(n, i, d),
                    g.sub(f.rj, f.rj, n),
        ...
        21: [function(a, b) {
            function c(a, b, c, n, o) {
                d.call(this, a, c, d.REVOLUTE),
                o = this.maxForce = "undefined" != typeof o ? o : Number.MAX_VALUE,
                this.pivotA = b,
                this.pivotB = n;
                ...
                q.computeGq = function() {
                    return h.rotate(i, b, a.angle),
                    h.rotate(j, n, c.angle),
                    h.add(m, c.position, j),
                ...
                ,
                r.minForce = q.minForce = -o,
                r.maxForce = q.maxForce = o,
                this.motorEquation = new f(a,c),
                this.motorEnabled = !1,
                this.angle = 0,
                this.lowerLimitEnabled = !1,
                this.upperLimitEnabled = !1,
                this.lowerLimit = 0,
                this.upperLimit = 0,
                this.upperLimitEquation = new g(a,c),
                this.lowerLimitEquation = new g(a,c),
        ...
        23: [function(a, b) {
            ...
            c.prototype.computeB = function(a, b, c) {
                ...
                p = 1 / b * (1 + this.restitution) * this.computeGW()) : (q = e.dot(l, k),
                p = this.computeGW());
        ...
        24: [function(a, b) {
            function c(a, b, c, d) {
                ...
                this.maxForce = "undefined" == typeof d ? 1e6 : d,
                this.bi = a,
                this.bj = b,
                this.stiffness = 1e6,
                this.relaxation = 4,
                this.G = new g.ARRAY_TYPE(6);
                for (var e = 0; 6 > e; e++)
                    this.G[e] = 0;
                this.offset = 0,
                this.a = 0,
            ...
            var e = a("../math/vec2")
              ...
              , g = a("../utils/Utils");
            c.prototype.constructor = c,
            c.prototype.updateSpookParams = function(a) {
            ...
            c.prototype.computeGiMf = function() {
                var a = this.bi
                  ...
                  , m = b.invInertia
                  , n = this.G;
                return e.scale(j, c, h),
                e.scale(k, f, i),
                this.transformedGmult(n, j, d * l, k, g * m)
            }
            ,
            ...
            c.prototype.addToWlambda = function(a) {
                ...
                g[0] = h[3],
                g[1] = h[4],
                e.scale(d, f, b.invMass * a),
                e.add(b.vlambda, b.vlambda, d),
                e.scale(d, g, c.invMass * a),
                e.add(c.vlambda, c.vlambda, d),
                b.wlambda += b.invInertia * h[2] * a,
                c.wlambda += c.invInertia * h[5] * a
            }
            ,
        ...
        26: [function(a, b) {
            ...
            var f = e.create()
              ...
              , i = e.fromValues(0, 1);
            c.prototype.computeGq = function() {
                return e.rotate(f, h, this.bi.angle + this.angle),
                e.rotate(g, i, this.bj.angle),
                e.dot(f, g)
            }
        }
        , {
        ...
        29: [function(a, b) {
            function c(a, b, e) {
                ...
                this.stiffness = "undefined" != typeof e.stiffness ? Number(e.stiffness) : 1e7,
                this.relaxation = "undefined" != typeof e.relaxation ? Number(e.relaxation) : 3,
                this.frictionStiffness = "undefined" != typeof e.frictionStiffness ? Number(e.frictionStiffness) : 1e7,
                this.frictionRelaxation = "undefined" != typeof e.frictionRelaxation ? Number(e.frictionRelaxation) : 3,
        ...
        34: [function(a, b) {
            function c(a) {
                ...
                this.motionState = 0 == this.mass ? c.STATIC : c.DYNAMIC,
            ...
            c.prototype.updateAABB = function() {
                for (var a = this.shapes, b = this.shapeOffsets, c = this.shapeAngles, e = a.length, f = 0; f !== e; f++) {
                    var g = a[f]
                      , h = j
                      , k = c[f] + this.angle;
                    d.rotate(h, b[f], this.angle),
                    d.add(h, h, this.position),
                    g.computeAABB(i, h, k),
                    0 === f ? this.aabb.copy(i) : this.aabb.extend(i)
                }
            ...
            c.prototype.removeShape = function(a) {
                ...
                this.shapeOffsets.splice(b, 1),
                this.shapeAngles.splice(b, 1),
                this.aabbNeedsUpdate = !0,
                !0) : !1
            }
            ,
            c.prototype.updateMassProperties = function() {
                if (this.motionState == c.STATIC || this.motionState == c.KINEMATIC)
            ...
            c.prototype.fromPolygon = function(a, b) {
                ...
                "undefined" == typeof b.skipSimpleCheck && !g.isSimple())
                    return !1;
            ...
            c.prototype.applyDamping = function(a) {
                if (this.motionState == c.DYNAMIC) {
                    a != this.lastDampingTimeStep && (this.lastDampingScale = Math.pow(1 - this.damping, a),
                    this.lastAngularDampingScale = Math.pow(1 - this.angularDamping, a),
                    this.lastDampingTimeStep = a);
                    var b = this.velocity;
                    d.scale(b, b, this.lastDampingScale),
            ...
            c.prototype.sleepTick = function(a) {
                if (this.allowSleep) {
                    ...
                    b === c.AWAKE && f > e ? (this.sleepState = c.SLEEPY,
                    this.timeLastSleepy = a,
                    this.emit(c.sleepyEvent)) : b === c.SLEEPY && e > f ? this.wakeUp() : b === c.SLEEPY && a - this.timeLastSleepy > this.sleepTimeLimit && this.sleep()
                }
            }
            ,
            c.sleepyEvent = {
        ...
        35: [function(a, b) {
            ...
            c.prototype.applyForce = function() {
                ...
                d.sub(w, u, n.position),
                d.sub(x, v, o.position),
                d.sub(p, v, u);
                var y = d.len(p);
                d.normalize(q, p),
                d.sub(r, o.velocity, n.velocity),
                d.crossZV(t, o.angularVelocity, x),
                d.add(r, r, t),
                d.crossZV(t, n.angularVelocity, w),
                d.sub(r, r, t),
                d.scale(s, q, -a * (y - c) - b * d.dot(r, q)),
                d.sub(n.force, n.force, s),
        ...
        40: [function(a, b) {
            ...
            ,
            c.prototype.updateArea = function() {
                for (var a = this.data, b = 0, c = 0; c < a.length - 1; c++)
        ...
        43: [function(a, b) {
            ...
            c.prototype.computeAABB = function(a, b, c) {
                ...
                0 == d ? (f(a.lowerBound, -Number.MAX_VALUE, -Number.MAX_VALUE),
                f(a.upperBound, Number.MAX_VALUE, 0)) : d == Math.PI / 2 ? (f(a.lowerBound, 0, -Number.MAX_VALUE),
                f(a.upperBound, Number.MAX_VALUE, Number.MAX_VALUE)) : d == Math.PI ? (f(a.lowerBound, -Number.MAX_VALUE, 0),
                f(a.upperBound, Number.MAX_VALUE, Number.MAX_VALUE)) : d == 3 * Math.PI / 2 ? (f(a.lowerBound, -Number.MAX_VALUE, -Number.MAX_VALUE),
                f(a.upperBound, 0, Number.MAX_VALUE)) : (f(a.lowerBound, -Number.MAX_VALUE, -Number.MAX_VALUE),
                f(a.upperBound, Number.MAX_VALUE, Number.MAX_VALUE)),
                e.add(a.lowerBound, a.lowerBound, b),
                e.add(a.upperBound, a.upperBound, b)
            }
            ,
        ...
        46: [function(a, b) {
            function c(a) {
                ...
                this.useGlobalEquationParameters = !0,
                this.stiffness = 1e6,
                this.relaxation = 4,
                this.useZeroRHS = !1,
                this.useNormalForceForFriction = !1,
            ...
            c.prototype.solve = function(a, b) {
                ...
                this.useZeroRHS)
                  , w = this.lambda;
                w.length < m && (w = this.lambda = new g.ARRAY_TYPE(m + this.arrayStep),
                this.Bs = new g.ARRAY_TYPE(m + this.arrayStep),
                this.invCs = new g.ARRAY_TYPE(m + this.arrayStep)),
                d(w);
                var x = this.invCs
                  , y = this.Bs
                  , w = this.lambda;
                if (u)
                    for (var z, A = 0; z = l[A]; A++)
                        y[A] = z.computeB(s, t, a),
                        x[A] = z.computeInvC(r);
                else
                    for (var z, A = 0; z = l[A]; A++)
                        z.updateSpookParams(a),
                        y[A] = z.computeB(z.a, z.b, a),
                        x[A] = z.computeInvC(z.eps);
                var z, B, A, C;
                if (0 !== m) {
                    for (A = 0; A !== o; A++)
                        n[A].resetConstraintVelocity();
                    for (f = 0; f !== i; f++) {
                        for (B = 0,
                        C = 0; C !== m; C++)
                            if (z = l[C],
            ...
            c.iterateEquation = function(a, b, c, d, e, f, g, i, j, k, l) {
                var m = d[a]
                  ...
                  , o = f[a]
                  , p = b.computeGWlambda();
                l && b instanceof h && j == k && (b.maxForce = b.contactEquation.multiplier * b.frictionCoefficient * i,
                b.minForce = -b.contactEquation.multiplier * b.frictionCoefficient * i);
                var q = b.maxForce
                  , r = b.minForce;
                g && (m = 0);
                var s = n * (m - p - c * o)
                  , t = o + s;
                return r * i > t ? s = r * i - o : t > q * i && (s = q * i - o),
                f[a] += s,
                b.multiplier = f[a] / i,
                b.addToWlambda(s),
                s
        ...
        47: [function(a, b) {
            ...
            c.prototype.getBodies = function() {
                for (var a = [], b = [], c = this.equations, d = 0; d !== c.length; d++) {
                    var e = c[d];
                    -1 === b.indexOf(e.bi.id) && (a.push(e.bi),
                    b.push(e.bi.id)),
                    -1 === b.indexOf(e.bj.id) && (a.push(e.bj),
                    b.push(e.bj.id))
                }
                return a
            }
            ...
            c.prototype.solve = function(a, b) {
                ...
                for (var d = this.equations.length, e = 0; e !== d; e++)
                    b.addEquation(this.equations[e]);
                for (var f = this.getBodies(), g = f.length, e = 0; e !== g; e++)
                    c.push(f[e]);
                b.solve(a, {
                    bodies: c
                })
        ...
        48: [function(a, b) {
            ...
            function d(a) {
                for (var b = a.length, c = 0; c !== b; c++) {
                    var d = a[c];
                    if (!d.visited && d.body.motionState != j)
                        return d
                }
                return !1
            }
            ...
            function f(a, b, c, e) {
                ...
                a.visited = !0,
                b(a, c, e); k.length; )
                    for (var f, g = k.pop(); f = d(g.children); )
                        f.visited = !0,
                        b(f, c, e),
                        k.push(f)
            }
            ...
            c.prototype.solve = function(a, b) {
                ...
                l.length = 0;
                for (var q = 0; q !== k; q++)
                    c.push(this._nodePool.length ? this._nodePool.pop() : {
                        body: g[q],
                        children: [],
                        eqs: [],
                        visited: !1
        ...
        51: [function(a, b) {
            function c(a) {
                ...
                this.narrowphase = new x(this),
                this.gravity = a.gravity || f.fromValues(0, -9.78),
                this.doProfiling = a.doProfiling || !1,
                this.lastStepTime = 0,
                this.broadphase = a.broadphase || new e,
                this.broadphase.setWorld(this),
                this.constraints = [],
                this.defaultFriction = .3,
                this.defaultRestitution = 0,
            ...
            var d = a("../solver/GSSolver")
              ...
              , w = a("../../package.json")
              , x = (a("../collision/Broadphase"),
            a("../collision/Narrowphase"))
              , y = a("../utils/Utils");
            b.exports = c;
            ...
            c.prototype = new Object(n.prototype),
            ...
            c.prototype.getContactMaterial = function(a, b) {
                for (var c = this.contactMaterials, d = 0, e = c.length; d !== e; d++) {
                    var f = c[d];
                    if (f.materialA === a && f.materialB === b || f.materialA === b && f.materialB === a)
                        return f
                }
                return !1
            }
            ...
            c.prototype.step = function(a, b, c) {
                ...
                0 == b)
                    ...
                    for (var e = 0; d > e; e++)
                        this.internalStep(a);
                    this.time += b,
                    this.fixedStepTime += d * a;
                    for (var f = this.time - this.fixedStepTime - a, g = 0; g !== this.bodies.length; g++) {
                        var h = this.bodies[g];
                        h.interpolatedPosition[0] = h.position[0] + h.velocity[0] * f,
                        h.interpolatedPosition[1] = h.position[1] + h.velocity[1] * f
                    }
                }
            }
            ,
            c.prototype.internalStep = function(a) {
                {
                    var b, d, e = this, g = this.doProfiling, h = this.springs.length, i = this.springs, j = this.bodies, k = this.gravity, l = this.solver, m = this.bodies.length, n = this.broadphase, p = this.narrowphase, q = this.constraints, r = B, s = (f.scale,
                    f.add);
                    f.rotate
                }
                this.lastTimeStep = a,
                ...
                if (this.applyGravity)
                    for (var u = 0; u !== m; u++) {
                        var v = j[u]
                          , w = v.force;
                        v.motionState == o.DYNAMIC && (f.scale(r, k, v.mass * v.gravityScale),
                        s(w, w, r))
                    }
                ...
                for (var P = this.overlappingShapesLastState, u = 0; u !== P.keys.length; u++) {
                    ...
                    if (P[Q] === !0 && !this.overlappingShapesCurrentState[Q]) {
                        ...
                        R.shapeA = P[Q + "_shapeA"],
                        R.shapeB = P[Q + "_shapeB"],
                        R.bodyA = P[Q + "_bodyA"],
                        R.bodyB = P[Q + "_bodyB"],
                        this.emit(R)
                    }
                }
                for (var u = 0; u !== P.keys.length; u++)
                    delete P[P.keys[u]];
                P.keys.length = 0;
                for (var S = this.overlappingShapesCurrentState, u = 0; u !== S.keys.length; u++)
                    P[S.keys[u]] = S[S.keys[u]],
                    P.keys.push(S.keys[u]);
                for (var u = 0; u !== S.keys.length; u++)
                    delete S[S.keys[u]];
                S.keys.length = 0;
                var T = this.preSolveEvent;
                T.contactEquations = p.contactEquations,
                T.frictionEquations = p.frictionEquations,
                this.emit(T),
                l.addEquations(p.contactEquations),
                l.addEquations(p.frictionEquations);
                var U = q.length;
                for (u = 0; u !== U; u++) {
                    var V = q[u];
                    V.update(),
                    l.addEquations(V.equations)
                }
            ...
            c.integrateBody = function(a, b) {
                var c = a.invMass
                  ...
                  , e = a.position
                  , g = a.velocity;
                a.fixedRotation || (a.angularVelocity += a.angularForce * a.invInertia * b,
                a.angle += a.angularVelocity * b),
                f.scale(E, d, b * c),
                f.add(g, E, g),
                f.scale(F, g, b),
                f.add(e, e, F),
            ...
            c.prototype.runNarrowphase = function(a, b, c, d, e, g, h, i, j, k, l) {
                if (0 !== (c.collisionGroup & h.collisionMask) && 0 !== (h.collisionGroup & c.collisionMask)) {
                    f.rotate(C, d, b.angle),
                    f.rotate(D, i, g.angle),
                    f.add(C, C, b.position),
                    f.add(D, D, g.position);
                    var m = e + b.angle
                      , n = j + g.angle;
                    a.enableFriction = k.friction > 0,
                    a.frictionCoefficient = k.friction;
                    var p;
                    p = b.motionState == o.STATIC || b.motionState == o.KINEMATIC ? g.mass : g.motionState == o.STATIC || g.motionState == o.KINEMATIC ? b.mass : b.mass * g.mass / (b.mass + g.mass),
                        ...
                        if (r = c.type < h.type ? q.call(a, b, c, C, m, g, h, D, n, s) : q.call(a, g, h, D, n, b, c, C, m, s)) {
                            ...
                            if (!this.overlappingShapesLastState[t]) {
                                ...
                                "number" == typeof r) {
                                    ...
                                    for (var v = a.contactEquations.length - r; v < a.contactEquations.length; v++)
                                        u.contactEquations.push(a.contactEquations[v])
                                }
                                this.emit(u)
                            }
                            ...
                            w.keys.push(t),
                            w[t + "_shapeA"] = c,
                            w.keys.push(t + "_shapeA"),
                            w[t + "_shapeB"] = h,
                            w.keys.push(t + "_shapeB"),
                            w[t + "_bodyA"] = b,
                            w.keys.push(t + "_bodyA"),
                            w[t + "_bodyB"] = g,
                            w.keys.push(t + "_bodyB"))
                        }
                    }
                }
            }
            ...
            c.prototype.toJSON = function() {
                ...
                for (var c = 0; c < this.constraints.length; c++) {
                    ...
                    if (e instanceof s)
                        f.type = "DistanceConstraint",
                        f.distance = e.distance,
                        f.maxForce = e.getMaxForce();
                    else if (e instanceof u)
                        f.type = "RevoluteConstraint",
                        f.pivotA = a(e.pivotA),
                        f.pivotB = a(e.pivotB),
                        f.maxForce = e.maxForce,
                        f.motorSpeed = e.getMotorSpeed(),
                        f.lowerLimit = e.lowerLimit,
                        f.lowerLimitEnabled = e.lowerLimitEnabled,
                        f.upperLimit = e.upperLimit,
                        f.upperLimitEnabled = e.upperLimitEnabled;
                    else if (e instanceof v)
                        f.type = "PrismaticConstraint",
                        f.localAxisA = a(e.localAxisA),
                        f.localAnchorA = a(e.localAnchorA),
                        f.localAnchorB = a(e.localAnchorB),
                        f.maxForce = e.maxForce;
                    else {
                        if (!(e instanceof t)) {
                        ...
                        f.type = "LockConstraint",
                        f.localOffsetB = a(e.localOffsetB),
                        f.localAngleB = e.localAngleB,
                        f.maxForce = e.maxForce
                    }
                ...
                for (var c = 0; c !== this.bodies.length; c++) {
                    for (var n = this.bodies[c], o = n.shapes, p = [], q = 0; q < o.length; q++) {
                        ...
                        if (d instanceof g)
                            ...
                            for (var w = [], x = 0; x < d.vertices.length; x++)
                                w.push(a(d.vertices[x]));
                            r = {
                                type: "Convex",
                                verts: w
                            }
                        ...
                        r.offset = a(n.shapeOffsets[q]),
                        r.angle = n.shapeAngles[q],
                        r.collisionGroup = d.collisionGroup,
                        r.collisionMask = d.collisionMask,
            ...
            c.upgradeJSON = function(a) {
                if (!a || !a.p2)
                    return !1;
                switch (a = JSON.parse(JSON.stringify(a)),
                a.p2) {
                case z:
                    return a;
                case "0.3":
                    for (var b = 0; b < a.constraints.length; b++) {
                        ...
                        "PrismaticConstraint" == d.type && (delete d.localAxisA,
                        delete d.localAxisB,
                        d.localAxisA = [1, 0],
                        d.localAnchorA = [0, 0],
                        d.localAnchorB = [0, 0])
            ...
            c.prototype.fromJSON = function(a) {
                ...
                for (var b = this.bodies, d = {}, e = 0; e !== a.bodies.length; e++) {
                    ...
                    for (var y = 0; y < w.length; y++) {
                        ...
                        z.collisionMask = A.collisionMask,
                        z.collisionGroup = A.collisionGroup,
                        z.material = A.material,
                        z.material && (z.material = new q,
                        z.material.id = A.material.id,
                        d[z.material.id + ""] = z.material),
                        x.addShape(z, A.offset, A.angle)
                    }
                    n.concavePath && (x.concavePath = n.concavePath),
                    this.addBody(x)
                }
                ...
                for (var e = 0; e < a.constraints.length; e++) {
                    ...
                    case "RevoluteConstraint":
                        E = new u(b[F.bodyA],F.pivotA,b[F.bodyB],F.pivotB,F.maxForce),
                        F.motorSpeed && (E.enableMotor(),
                        E.setMotorSpeed(F.motorSpeed)),
                        E.lowerLimit = F.lowerLimit || 0,
                        E.upperLimit = F.upperLimit || 0,
                        E.lowerLimitEnabled = F.lowerLimitEnabled || !1,
                        E.upperLimitEnabled = F.upperLimitEnabled || !1;
                        break;
                ...
                for (var r = this.narrowphase, s = [], t = 0, u = b.length; t !== u; t++)
                    for (var v = b[t], w = 0, x = v.shapes.length; w !== x; w++) {
                        var y = v.shapes[w]
                          ...
                          , A = v.shapeAngles[w] || 0;
                        f.rotate(n, z, v.angle),
                        f.add(n, n, v.position);
                        var B = A + v.angle;
...
Phaser.Physics.P2 = function(a, b) {
    this.game = a,
    "undefined" != typeof b && b.hasOwnProperty("gravity") && b.hasOwnProperty("broadphase") || (b = {
        gravity: [0, 0],
        broadphase: new p2.SAPBroadphase
    }),
    this.world = new p2.World(b),
    this.frameRate = 1 / 60,
...
Phaser.Physics.P2.prototype = {
    ...
    enable: function(a, b, c) {
        ...
        if (Array.isArray(a))
            for (d = a.length; d--; )
                a[d]instanceof Phaser.Group ? this.enable(a[d].children, b, c) : (this.enableBody(a[d], b),
                c && a[d].hasOwnProperty("children") && a[d].children.length > 0 && this.enable(a[d], b, !0));
        else
            a instanceof Phaser.Group ? this.enable(a.children, b, c) : (this.enableBody(a, b),
            c && a.hasOwnProperty("children") && a.children.length > 0 && this.enable(a.children, b, !0))
    },
    enableBody: function(a, b) {
        a.hasOwnProperty("body") && null === a.body && (a.body = new Phaser.Physics.P2.Body(this.game,a,a.x,a.y,1),
        a.body.debug = b,
        a.anchor.set(.5))
    },
    ...
    postBroadphaseHandler: function(a) {
        if (this.postBroadphaseCallback)
            for (var b = a.pairs.length; b -= 2; )
                1 === a.pairs[b].id || 1 === a.pairs[b + 1].id || this.postBroadphaseCallback.call(this.callbackContext, a.pairs[b].parent, a.pairs[b + 1].parent) || a.pairs.splice(b, 2)
    },
    ...
    beginContactHandler: function(a) {
        a.bodyA.id > 1 && a.bodyB.id > 1 && (this.onBeginContact.dispatch(a.bodyA, a.bodyB, a.shapeA, a.shapeB, a.contactEquations),
    ...
    endContactHandler: function(a) {
        a.bodyA.id > 1 && a.bodyB.id > 1 && (this.onEndContact.dispatch(a.bodyA, a.bodyB, a.shapeA, a.shapeB),
    ...
    setWorldMaterial: function(a, b, c, d, e) {
        ...
        "undefined" == typeof d && (d = !0),
        "undefined" == typeof e && (e = !0),
        b && this._wallShapes[0] && (this._wallShapes[0].material = a),
        c && this._wallShapes[1] && (this._wallShapes[1].material = a),
        d && this._wallShapes[2] && (this._wallShapes[2].material = a),
        e && this._wallShapes[3] && (this._wallShapes[3].material = a)
    },
    updateBoundsCollisionGroup: function(a) {
        "undefined" == typeof a && (a = !0);
        for (var b = 0; 4 > b; b++)
            this._wallShapes[b] && (this._wallShapes[b].collisionGroup = a ? this.boundsCollisionGroup.mask : this.everythingCollisionGroup.mask)
    },
    setBounds: function(a, b, c, d, e, f, g, h, i) {
        ...
        if (null !== this.bounds) {
            ...
            this.bounds.position[0] = this.pxmi(l),
            this.bounds.position[1] = this.pxmi(m)
        } else
            this.bounds = new p2.Body({
                mass: 0,
                position: [this.pxmi(l), this.pxmi(m)]
            });
        e && (this._wallShapes[0] = new p2.Plane,
        i && (this._wallShapes[0].collisionGroup = this.boundsCollisionGroup.mask),
        this.bounds.addShape(this._wallShapes[0], [this.pxmi(-j), 0], 1.5707963267948966)),
        f && (this._wallShapes[1] = new p2.Plane,
        i && (this._wallShapes[1].collisionGroup = this.boundsCollisionGroup.mask),
        this.bounds.addShape(this._wallShapes[1], [this.pxmi(j), 0], -1.5707963267948966)),
        g && (this._wallShapes[2] = new p2.Plane,
        i && (this._wallShapes[2].collisionGroup = this.boundsCollisionGroup.mask),
        this.bounds.addShape(this._wallShapes[2], [0, this.pxmi(-k)], -3.141592653589793)),
        h && (this._wallShapes[3] = new p2.Plane,
        i && (this._wallShapes[3].collisionGroup = this.boundsCollisionGroup.mask),
        this.bounds.addShape(this._wallShapes[3], [0, this.pxmi(k)])),
    ...
    createDistanceConstraint: function(a, b, c, d) {
        ...
        b = this.getBody(b),
        a && b ? this.addConstraint(new Phaser.Physics.P2.DistanceConstraint(this,a,b,c,d)) : void console.warn("Cannot create Constraint, invalid body objects given")
    },
    createGearConstraint: function(a, b, c, d) {
        return a = this.getBody(a),
        b = this.getBody(b),
        a && b ? this.addConstraint(new Phaser.Physics.P2.GearConstraint(this,a,b,c,d)) : void console.warn("Cannot create Constraint, invalid body objects given")
    },
    createRevoluteConstraint: function(a, b, c, d, e) {
        return a = this.getBody(a),
        c = this.getBody(c),
        a && c ? this.addConstraint(new Phaser.Physics.P2.RevoluteConstraint(this,a,b,c,d,e)) : void console.warn("Cannot create Constraint, invalid body objects given")
    },
    createLockConstraint: function(a, b, c, d, e) {
        return a = this.getBody(a),
        b = this.getBody(b),
        a && b ? this.addConstraint(new Phaser.Physics.P2.LockConstraint(this,a,b,c,d,e)) : void console.warn("Cannot create Constraint, invalid body objects given")
    },
    createPrismaticConstraint: function(a, b, c, d, e, f, g) {
        return a = this.getBody(a),
        b = this.getBody(b),
        a && b ? this.addConstraint(new Phaser.Physics.P2.PrismaticConstraint(this,a,b,c,d,e,f,g)) : void console.warn("Cannot create Constraint, invalid body objects given")
    },
    ...
    createMaterial: function(a, b) {
        ...
        "undefined" != typeof b && b.setMaterial(c),
        c
    },
    ...
    getConstraints: function() {
        for (var a = [], b = this.world.constraints.length; b--; )
            a.push(this.world.constraints[b].parent);
        return a
    },
    hitTest: function(a, b, c, d) {
        ...
        "undefined" == typeof d && (d = !1);
        for (var e = [this.pxmi(a.x), this.pxmi(a.y)], f = [], g = b.length; g--; )
            b[g]instanceof Phaser.Physics.P2.Body && (!d || b[g].data.motionState !== p2.Body.STATIC) ? f.push(b[g].data) : b[g]instanceof p2.Body && b[g].parent && (!d || b[g].motionState !== p2.Body.STATIC) ? f.push(b[g]) : b[g]instanceof Phaser.Sprite && b[g].hasOwnProperty("body") && (!d || b[g].body.data.motionState !== p2.Body.STATIC) && f.push(b[g].body.data);
    ...
    createCollisionGroup: function(a) {
        ...
        this._wallShapes[0] && (this._wallShapes[0].collisionMask = this._wallShapes[0].collisionMask | b),
        this._wallShapes[1] && (this._wallShapes[1].collisionMask = this._wallShapes[1].collisionMask | b),
        this._wallShapes[2] && (this._wallShapes[2].collisionMask = this._wallShapes[2].collisionMask | b),
        this._wallShapes[3] && (this._wallShapes[3].collisionMask = this._wallShapes[3].collisionMask | b),
        this._collisionGroupID++;
        var c = new Phaser.Physics.P2.CollisionGroup(b);
        return this.collisionGroups.push(c),
    ...
    setCollisionGroup: function(a, b) {
        if (a instanceof Phaser.Group)
            for (var c = 0; c < a.total; c++)
                a.children[c].body && a.children[c].body.type === Phaser.Physics.P2JS && a.children[c].body.setCollisionGroup(b);
        else
            a.body.setCollisionGroup(b)
    },
    createSpring: function(a, b, c, d, e, f, g, h, i) {
        return a = this.getBody(a),
        b = this.getBody(b),
        a && b ? this.addSpring(new Phaser.Physics.P2.Spring(this,a,b,c,d,e,f,g,h,i)) : void console.warn("Cannot create Spring, invalid body objects given")
    },
    createBody: function(a, b, c, d, e, f) {
        ...
        return d && this.world.addBody(g.data),
        g
    },
...
Phaser.Physics.P2.Body.prototype = {
    ...
    createGroupCallback: function(a, b, c) {
        ...
        delete this._groupCallbacksContext[a.mask]) : (this._groupCallbacks[a.mask] = b,
    ...
    addPolygon: function(a, b) {
        ...
        if (1 === b.length && Array.isArray(b[0]))
            ...
            for (var d = 0, e = b.length; e > d; d += 2)
                c.push([b[d], b[d + 1]]);
        var f = c.length - 1;
    ...
    loadPolygon: function(a, b, c) {
        ...
        if (1 === d.length) {
            var e = [];
            d = d.pop();
            for (var f = 0, g = d.shape.length; g > f; f += 2)
                e.push([d.shape[f], d.shape[f + 1]]);
            return this.addPolygon(c, e)
        }
        for (var h = p2.vec2.create(), f = 0; f < d.length; f++) {
            for (var i = [], j = 0; j < d[f].shape.length; j += 2)
                i.push([this.world.pxmi(d[f].shape[j]), this.world.pxmi(d[f].shape[j + 1])]);
            for (var k = new p2.Convex(i), l = 0; l !== k.vertices.length; l++) {
                var m = k.vertices[l];
                p2.vec2.sub(m, m, k.centerOfMass)
            }
            p2.vec2.scale(h, k.centerOfMass, 1),
            h[0] -= this.world.pxmi(this.sprite.width / 2),
            h[1] -= this.world.pxmi(this.sprite.height / 2),
            k.updateTriangles(),
            k.updateCenterOfMass(),
            k.updateBoundingRadius(),
            this.data.addShape(k, h)
        }
    ...
    loadData: function(a, b, c) {
        var d = this.game.cache.getPhysicsData(a, b);
        d && d.shape && (this.mass = d.density,
        this.loadPolygon(a, b, c))
    }
},
...
Object.defineProperty(Phaser.Physics.P2.Body.prototype, "static", {
    ...
    set: function(a) {
        a && this.data.motionState !== Phaser.STATIC ? (this.data.motionState = Phaser.STATIC,
        this.mass = 0) : a || this.data.motionState !== Phaser.STATIC || (this.data.motionState = Phaser.DYNAMIC,
        0 === this.mass && (this.mass = 1))
    }
}),
Object.defineProperty(Phaser.Physics.P2.Body.prototype, "dynamic", {
    ...
    set: function(a) {
        a && this.data.motionState !== Phaser.DYNAMIC ? (this.data.motionState = Phaser.DYNAMIC,
        0 === this.mass && (this.mass = 1)) : a || this.data.motionState !== Phaser.DYNAMIC || (this.data.motionState = Phaser.STATIC,
        this.mass = 0)
    }
}),
Object.defineProperty(Phaser.Physics.P2.Body.prototype, "kinematic", {
    ...
    set: function(a) {
        a && this.data.motionState !== Phaser.KINEMATIC ? (this.data.motionState = Phaser.KINEMATIC,
        this.mass = 4) : a || this.data.motionState !== Phaser.KINEMATIC || (this.data.motionState = Phaser.STATIC,
        this.mass = 0)
    }
}),
...
Object.defineProperty(Phaser.Physics.P2.Body.prototype, "debug", {
    ...
    set: function(a) {
        a && !this.debugBody ? this.debugBody = new Phaser.Physics.P2.BodyDebug(this.game,this.data) : !a && this.debugBody && (this.debugBody.destroy(),
        this.debugBody = null)
    }
}),
...
Phaser.Physics.P2.BodyDebug = function(a, b, c) {
    ...
    this.settings = Phaser.Utils.extend(d, c),
    this.ppu = this.settings.pixelsPerLengthUnit,
    this.ppu = -1 * this.ppu,
    this.body = b,
    this.canvas = new Phaser.Graphics(a),
...
Phaser.Utils.extend(Phaser.Physics.P2.BodyDebug.prototype, {
    ...
    updateSpriteTransform: function() {
        return this.position.x = this.body.position[0] * this.ppu,
        ...
        h instanceof p2.Body && h.shapes.length) {
            ...
            for (d = 0; d !== p; ) {
                ...
                b instanceof p2.Circle)
                    ...
                    m = p2.vec2.create(),
                    e = n = 0,
                    o = b.vertices.length; o >= 0 ? o > n : n > o; e = o >= 0 ? ++n : --n)
                        k = b.vertices[e],
                    ...
                    b instanceof p2.Plane ? this.drawPlane(j, i[0] * this.ppu, -i[1] * this.ppu, c, f, 5 * g, 10 * g, 10 * g, 100 * this.ppu, a) : b instanceof p2.Line ? this.drawLine(j, b.length * this.ppu, f, g) : b instanceof p2.Rectangle && this.drawRectangle(j, i[0] * this.ppu, -i[1] * this.ppu, a, b.width * this.ppu, b.height * this.ppu, f, c, g);
                d++
            }
        }
    },
    ...
    drawConvex: function(a, b, c, d, e, f, g, h) {
        ...
        j = 0; j !== b.length; )
            ...
            j++;
        return a.endFill(),
        b.length > 2 ? (a.moveTo(b[b.length - 1][0], -b[b.length - 1][1]),
        a.lineTo(b[0][0], -b[0][1])) : void 0
    },
    drawPath: function(a, b, c, d, e) {
        var f, g, h, i, j, k, l, m, n, o, p, q, r;
        for ("undefined" == typeof e && (e = 1),
        "undefined" == typeof c && (c = 0),
        a.lineStyle(e, c, 1),
...
Phaser.Physics.P2.Material = function(a) {
    this.name = a,
...
Phaser.Physics.P2.ContactMaterial = function(a, b, c) {
...
Phaser.Physics.P2.CollisionGroup = function(a) {
    this.mask = a
}
;
var GameCtrl = {
...
function() {
    ...
    GameCtrl.MainMenu.prototype = {
        ...
        create: function() {
            ...
            d.scale.x = 4,
            d.scale.y = 4,
            this.game.physics.enable(d, Phaser.Physics.ARCADE),
            d.body.velocity.x = 100,
            d.animations.add("run", Phaser.Animation.generateFrameNames("clown", 0, 2, "", 4), 10, !0),
            d.animations.play("run", 8, !0),
            this.enterPressed = !1
        },
        update: function() {
            !this.enterPressed && this.game.input.keyboard.isDown(Phaser.Keyboard.ENTER) && (this.enterPressed = !0,
            this.blinkedTimes = -1,
            this.timerBlinker = setInterval(function(a) {
                a.blinkedTimes++,
                a.blinkedTimes > 10 && (clearInterval(a.timerBlinker),
                GameCtrl.data = {
                    textToRender: "STAGE 01",
                    nextState: "Stage01"
                },
                a.game.state.start("Prestage")),
                a.startText.visible = !a.startText.visible
            }, 30, this))
        }
    }
}();
...
!function() {
    ...
    GameCtrl.Preloader.prototype = {
        ...
        update: function() {
            this.cache.isSoundDecoded("stage1") && this.ready === !1 && (this.ready = !0,
    ...
    GameCtrl.Prestage.prototype = {
        create: function() {
            ...
            setTimeout(function(a) {
                if (GameCtrl.data.nextState === 'Stage01') {
...
function() {
    ...
    GameCtrl.Stage01.prototype = {
        _createMeters: function() {
            for (var a, b = this.add.graphics(0, 0), c = 10; c >= 0; c--)
                a = 780 * (10 - c),
                this.add.text(a + 15, 694, 10 * c + " m", {
                ...
                b.lineStyle(2, 0, 1),
                b.beginFill(0, 1),
                b.drawRect(a, 690, 130, 50),
                b.lineStyle(5, 13903616, 1),
                b.drawRect(a + 5, 695, 120, 40)
        },
        _createPlayer: function() {
            ...
            this.physics.enable(this.clown, Phaser.Physics.ARCADE, !0),
            this.lion.addChild(this.clown),
            this.lion.scale.x = 3,
            this.lion.scale.y = 3,
            this.lion.animations.add("runLion", Phaser.Animation.generateFrameNames("lion", 0, 2, "", 4), 3, !0),
            this.lion.animations.add("idleLion", Phaser.Animation.generateFrameNames("lion", 0, 0, "", 4), 1, !0),
            this.clown.isRunning = !1,
            this.lion.body.collideWorldBounds = !0
        },
        _createObstacles: function() {
            ...
            for (var a = this.world.bounds.width - 800, b = 1200; a > b; b += 800) {
                ...
                this.physics.enable(c, Phaser.Physics.ARCADE),
                c.body.setSize(38, 48, -14, -15),
                c.body.x = b,
                c.body.y = 600,
                c.body.immovable = !0,
                c.scale.x = 3,
            ...
            this.obstacles.callAll("animations.add", "animations", "burnPot", Phaser.Animation.generateFrameNames("firepot", 0, 1, "", 4), 10, !0),
        ...
        _createFireCirclesLeft: function() {
            ...
            for (var b = 800; b < this.world.bounds.width; b += 800) {
                b % 2 && (b -= 300 + Math.floor(100 * Math.random()) + 1),
                b++;
                var c = this.add.sprite(b, 335, "clown", "firecirclel0000");
                this.game.physics.enable(c, Phaser.Physics.ARCADE),
                c.animations.add("burnCircleLeft", a, 5, !0),
                this.firecirclesLeft.add(c)
            }
        ...
        _createFireCirclesRight: function() {
            ...
            this.firecirclesLeft.forEach(function(b) {
                var c = b.body.x + 30
                  , d = this.game.add.sprite(c, 335, "clown", "firecircler0000");
                this.physics.enable(d, Phaser.Physics.ARCADE),
                d.animations.add("burnCircleRigth", a, 5, !0),
                this.firecirclesRight.add(d)
            }, this),
        ...
        _createFireCirclesCollision: function() {
            ...
            this.firecirclesLeft.forEach(function(a) {
                var b = a.body.x + 30
                  , c = this.game.add.sprite(b - 10, 554);
                this.physics.enable(c, Phaser.Physics.ARCADE),
                c.body.setSize(25, 150),
                this.fireCollisionGroup.add(c)
            }, this),
        ...
        create: function() {
            ...
            this.world.setBounds(0, 0, 8192, 200),
            this.background = this.add.tileSprite(0, 200, 8192, 552, "stage01"),
            this._createMeters(),
            ...
            this.endStage = this.game.add.sprite(7892, 620, "clown", "endLevel1"),
            ...
            this.endStage.body.immovable = !0,
            this.endStage.body.collideWorldBounds = !0,
            this.floor.body.immovable = !0,
            this.floor.body.collideWorldBounds = !0,
            ...
            this.recicleFireCirclesWall.body.immovable = !0,
        ...
        triggerGameover: function() {
            ...
            setTimeout(function() {
                a.lion.animations.stop(),
                a.clown.frameName = "clownburn0000",
                a.lion.frameName = "lionburn0000",
                a.lion.body.gravity.y = 0,
                a.lion.body.speed = 0,
                a.lion.body.velocity.y = 0,
                a.lion.body.velocity.x = 0,
                a.firecirclesRight.setAll("body.velocity.x", 0),
                a.firecirclesLeft.setAll("body.velocity.x", 0)
            }, 1),
            setTimeout(function() {
                a.game.state.start("Stage01"),
                a.failureSound.stop()
            }, 3100),
            this.gameover = !0
        },
        _recicleFireCircle: function() {
            ...
            a.body.x = this.world.width,
            b.body.x = this.world.width + 30,
            c.body.x = this.world.width + 20,
            c.body.velocity.x = a.body.velocity.x,
            this.firecirclesLeft.remove(a),
            this.firecirclesLeft.add(a),
            this.firecirclesRight.remove(b),
            this.firecirclesRight.add(b),
            this.fireCollisionGroup.remove(c),
            this.fireCollisionGroup.add(c)
        },
        triggerWin: function() {
            GameCtrl.data = {
        ...
        update: function() {
            if (!this.gameover) {
                this.lion.body.x < this.world.width - 1600 && this.game.physics.arcade.collide(this.recicleFireCirclesWall, this.fireCollisionGroup, this._recicleFireCircle, null, this),
                ...
                a ? (this.clown.frameName = "clownStandJump0000",
                this.lion.frameName = "lion0002") : this.clown.frameName = "clownStand0000",
                this.cursors.up.isDown && !a && (this.lion.body.velocity.y = -480),
                a || (this.cursors.right.isDown ? (this.clown.isRunning = !0,
                this.lion.body.velocity.x = 200,
                this.lion.animations.play("runLion", 10, !0)) : this.cursors.left.isDown ? (this.clown.isRunning = !0,
                this.lion.body.velocity.x = -100,
                this.lion.animations.play("runLion", 6, !0)) : (this.lion.body.velocity.x = 0,
                this.clown.isRunning = !1,
        ...
        render: function() {
            CIRCUSDEBUG && (this.game.debug.bodyInfo(this.lion, 32, 320),
            ...
            this.fireCollisionGroup.forEach(function(a) {
                this.game.debug.body(a)
            }, this))
        },
        quitGame: function() {
...
function() {
    ...
    GameCtrl.Stage02.prototype = {
        _createMeters: function() {
            for (var a, b = this.game.add.graphics(0, 0), c = 10; c >= 0; c--)
                a = 705 * (10 - c),
                this.add.text(a + 15, 694, 10 * c + " m", {
                    font: '46px "arcadeclasic"',
                    fill: "#fff",
        ...
        _createPlayer: function() {
            ...
            this.physics.enable(this.player, Phaser.Physics.ARCADE, !0),
            this.player.body.setSize(35, 69, 0, 0),
            this.player.animations.add("walkBalance", Phaser.Animation.generateFrameNames("walkBalance", 0, 2, "", 0), 3, !0),
        ...
        _addMonkey: function() {
            if (!(this.monkeys.total > 3))
                for (var a = function(a) {
                    ...
                    return c.scale.x = 3,
                    c.scale.y = 3,
                    c.body.velocity.x = -90,
                    c.animations.add("monkey", Phaser.Animation.generateFrameNames("monkey", 0, 2, "", 0), 3, !0),
                    c.animations.play("monkey", 6),
                    c.checkWorldBounds = !0,
                    c.events.onOutOfBounds.add(this._monkyOut, this),
                    c.body.setSize(44, 49, 0, 0),
                    c.body.gravity.y = 400,
                    c
                }, b = this.rnd.integerInRange(1, 100), c = b > 40 ? this.rnd.integerInRange(1, 4) : 1, d = 50, e = this.rnd.integerInRange(200, 700), f = 0; c > f; f++) {
                    b = 100,
                    f > 1 && (d = 100 * f,
                    e = this.rnd.integerInRange(1e3, 2e3));
                    var g = f > 0 ? this.monkeys.getAt(this.monkeys.length - 1).x + d : null
                      , h = a.call(this, g);
                    h.jumpTime = b > 70 ? e : !1,
                    h.lastJump = this.time.lastTime
                }
        },
        _createObstacles: function() {
            this.monkeys = this.add.group(),
            this.monkeys.enableBody = !0,
        ...
        create: function() {
            ...
            this.cursors = this.game.input.keyboard.createCursorKeys(),
            this.world.setBounds(0, 0, 8192, 200),
            this.background = this.add.tileSprite(0, 200, 8192, 552, "stage02"),
            this._createMeters(),
            this._createPlayer(),
            this._createObstacles(),
            ...
            this.physics.enable(this.floor, Phaser.Physics.ARCADE),
            this.physics.enable(this.endStage, Phaser.Physics.ARCADE),
            this.endStage.body.position.y = this.player.position.y,
            this.endStage.scale.x = 3,
            this.endStage.scale.y = 3,
            this.endStage.body.immovable = !0,
            this.endStage.body.collideWorldBounds = !0,
        ...
        triggerGameover: function() {
            ...
            this.failureSound.play(),
            setTimeout(function() {
                a.player.animations.stop(),
                a.player.frameName = "clownburn0000",
                a.player.body.gravity.y = 0,
                a.player.body.speed = 0,
                a.player.body.velocity.y = 0,
                a.player.body.velocity.x = 0,
                a.monkeys.setAll("body.velocity.x", 0),
                a.monkeys.setAll("body.gravity.y", 0),
                a.monkeys.setAll("body.velocity.y", 0),
                a.monkeys.callAll("animations.stop", "animations")
            }, 1),
            setTimeout(function() {
                a.game.state.start("Stage02"),
                a.failureSound.stop()
            }, 3100),
            this.gameover = !0
        },
        ...
        update: function() {
            if (!this.gameover) {
                ...
                this.monkeys.forEach(function(a) {
                ...
                // this.game.physics.arcade.collide(this.endStage, this.player, this.triggerWin, null, this),
                ...
                a && (this.player.frameName = "jumpBalance"),
                this.cursors.up.isDown && !a && (this.player.body.velocity.y = -480),
                a || (this.cursors.right.isDown ? (this.player.body.velocity.x = 150,
                this.player.animations.play("walkBalance", 10, !0)) : this.cursors.left.isDown ? (this.player.body.velocity.x = -130,
                this.player.animations.play("walkBalance", 5, !0)) : (this.player.body.velocity.x = 0,
                this.player.animations.stop(),
                this.player.frameName = "walkBalance2"))
            }
        },
        render: function() {
            CIRCUSDEBUG && (this.game.debug.bodyInfo(this.player, 32, 320),
